package com.Vivideru.Goety.client.render.animation;
...
public class CerberusAnimations {
	...
	public static final AnimationDefinition fire_breath = AnimationDefinition.Builder.withLength(2.0F).looping()
		.addAnimation("head1", new AnimationChannel(AnimationChannel.Targets.ROTATION,
		...
		.addAnimation("tail", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.6667F, KeyframeAnimations.degreeVec(2.4728F, -1.6887F, 1.8437F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.0F, KeyframeAnimations.degreeVec(1.83F, 0.38F, -0.5F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.3333F, KeyframeAnimations.degreeVec(1.1837F, 2.4509F, -2.8395F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(2.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("bone2", new AnimationChannel(AnimationChannel.Targets.ROTATION,
