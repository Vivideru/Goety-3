...
public class ModBlockLootProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(ModBlocks.FIRETHORN.get(), (p_249159_) -> {
            return this.applyExplosionDecay(p_249159_, LootTable.lootTable().withPool(LootPool.lootPool().when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(ModBlocks.FIRETHORN.get()).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(BlockStateProperties.AGE_3, 3))).add(LootItem.lootTableItem(ModBlocks.FIRETHORN_BERRIES.get())).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))).apply(ApplyBonusCount.addUniformBonusCount(this.fortune()))).withPool(LootPool.lootPool().when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(ModBlocks.FIRETHORN.get()).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(BlockStateProperties.AGE_3, 2))).add(LootItem.lootTableItem(ModBlocks.FIRETHORN_BERRIES.get())).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))).apply(ApplyBonusCount.addUniformBonusCount(this.fortune()))));
        });
        this.add(ModBlocks.COBBLED_DIRT.get(), (block) -> {
           return LootTable.lootTable().withPool(LootPool.lootPool().add(AlternativesEntry.alternatives(
                    LootItem.lootTableItem(ModBlocks.COBBLED_DIRT.get()).when(this.hasSilkTouch()),
        ...
        this.add(ModBlocks.COBBLED_DARK_DIRT.get(), (block) -> {
            return LootTable.lootTable().withPool(LootPool.lootPool().add(AlternativesEntry.alternatives(
                    LootItem.lootTableItem(ModBlocks.COBBLED_DARK_DIRT.get()).when(this.hasSilkTouch()),
                    LootItem.lootTableItem(Items.COBBLESTONE).when(HAS_PICKAXE),
        ...
        this.add(ModBlocks.DETRITUS_DUST.get(), (p_251108_) -> {
            ...
            }).when(this.doesNotHaveSilkTouch()), AlternativesEntry.alternatives(LayerBlock.LAYERS.getPossibleValues(), (p_251216_) -> {
    ...
    protected LootTable.Builder createRottenLeavesDrops(Block p_124264_, Block p_124265_, float... p_124266_) {
        return createLeavesDrops(p_124264_, p_124265_, p_124266_).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).when(this.doesNotHaveShearsOrSilkTouch()).add(applyExplosionCondition(p_124264_, LootItem.lootTableItem(Items.ROTTEN_FLESH)).when(BonusLevelTableCondition.bonusLevelFlatChance(this.fortune(), 0.005F, 0.0055555557F, 0.00625F, 0.008333334F, 0.025F))));
    }

    protected LootTable.Builder createChorusLeavesDrops(Block p_250088_, Block p_250731_, float... p_248949_) {
        return createSilkTouchOrShearsDispatchTable(p_250088_, this.applyExplosionCondition(p_250088_, LootItem.lootTableItem(p_250731_)).when(BonusLevelTableCondition.bonusLevelFlatChance(this.fortune(), p_248949_))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).when(this.doesNotHaveShearsOrSilkTouch()).add(this.applyExplosionDecay(p_250088_, LootItem.lootTableItem(ModBlocks.CHORUS_VINE.get().asItem()).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))).when(BonusLevelTableCondition.bonusLevelFlatChance(this.fortune(), NORMAL_LEAVES_STICK_CHANCES))));
    }
    ...
    protected LootTable.Builder createOreDrop(Block p_124140_, Item p_124141_) {
        return createSilkTouchDispatchTable(p_124140_, applyExplosionDecay(p_124140_, LootItem.lootTableItem(p_124141_).apply(ApplyBonusCount.addOreBonusCount(this.fortune()))));
    }
