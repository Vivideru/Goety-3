...
public class ModEntityTypeTagsProvider extends IntrinsicHolderTagsProvider<EntityType<?>> {
    ...
    protected void addTags(HolderLookup.Provider p_255894_) {
        ...
        this.tag(EntityTypeTags.FALL_DAMAGE_IMMUNE).add(
                ...
                ModEntityType.STORM_CASTER.get(),
                ModEntityType.STONE_MINISTROSITY.get(),
                ModEntityType.REDSTONE_MINISTROSITY.get(),
                ModEntityType.ICE_GOLEM.get(),
                ModEntityType.SQUALL_GOLEM.get(),
        ...
        this.tag(EntityTypeTags.UNDEAD)
                ...
                .addTag(ModTags.EntityTypes.NECROMANCERS)
                .addTag(ModTags.EntityTypes.REAPERS)
                .addTag(ModTags.EntityTypes.WRAITHS)
                .addTag(ModTags.EntityTypes.BOUND_ILLAGERS)
                .add(
                        ModEntityType.APOSTLE.get(),
                        ModEntityType.FRAYED.get(),
                        ModEntityType.RATTLED.get(),
                        ModEntityType.CRYPT_SLIME.get(),
                        ModEntityType.CRYPT_SLIME_SERVANT.get(),
                        ModEntityType.HAUNTED_ARMOR.get(),
                        ModEntityType.HAUNTED_ARMOR_SERVANT.get(),
                        ModEntityType.HAUNTED_SKULL.get(),
                        ModEntityType.PHANTOM_SERVANT.get(),
                        ModEntityType.SKELETON_VILLAGER_SERVANT.get(),
                        ModEntityType.SKELETON_WOLF.get(),
                        ModEntityType.GRAVE_GOLEM.get(),
                        ModEntityType.HAUNT.get(),
                        ModEntityType.WIGHT.get(),
                        ModEntityType.SKULL_LORD.get(),
        ...
        this.tag(EntityTypeTags.RAIDERS).add(
                ...
                ModEntityType.REPROBATE.get(),
                ModEntityType.HERETIC.get(),
                ModEntityType.CRONE.get(),
                ModEntityType.HERESIARCH.get(),
