...
public class ModFoodData {
    ...
    public void eat(ItemStack itemStack, @Nullable LivingEntity entity) {
        ...
        if (foodproperties != null) {
            this.foodLevel = Math.min(foodproperties.nutrition() + this.foodLevel, 20);
            this.saturationLevel = Math.min(this.saturationLevel + foodproperties.saturation(), (float)this.foodLevel);
        }
    }
