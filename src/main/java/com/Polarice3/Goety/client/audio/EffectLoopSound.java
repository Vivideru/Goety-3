...
public class EffectLoopSound extends AbstractTickableSoundInstance {
    ...
    public void tick() {
        if (this.entity == null || this.entity.isRemoved() || !this.entity.isAlive() || this.effect == null || !this.entity.hasEffect(BuiltInRegistries.MOB_EFFECT.wrapAsHolder(this.effect))){
            this.stop();
        } else {
