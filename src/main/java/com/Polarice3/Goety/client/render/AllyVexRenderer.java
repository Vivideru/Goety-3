...
public class AllyVexRenderer extends MobRenderer<AllyVex, MinionModel<AllyVex>> {
    private static final ResourceLocation VEX_LOCATION = ResourceLocation.parse("textures/entity/illager/vex.png");
    private static final ResourceLocation VEX_CHARGING_LOCATION = ResourceLocation.parse("textures/entity/illager/vex_charging.png");
