    ...
    public void renderToBuffer(PoseStack p_102034_, VertexConsumer p_102035_, int p_102036_, int p_102037_, int color) {
        if (this.young) {
            ...
            this.headParts().forEach((p_102081_) -> {
                p_102081_.render(p_102034_, p_102035_, p_102036_, p_102037_, color);
            });
            p_102034_.popPose();
            p_102034_.pushPose();
            float f1 = 1.0F / 2.0F;
            ...
            this.bodyParts().forEach((p_102071_) -> {
                p_102071_.render(p_102034_, p_102035_, p_102036_, p_102037_, color);
            });
            p_102034_.popPose();
        } else {
            super.renderToBuffer(p_102034_, p_102035_, p_102036_, p_102037_, color);
        }
