...
public class MandalaRenderer implements BlockEntityRenderer<MandalaBlockEntity> {
    ...
    private void vertex(VertexConsumer consumer, Matrix4f m, PoseStack.Pose n, float x, float y, float z, float u, float v, float nx, float ny, float nz, int light, int overlay) {
        consumer.addVertex(m, x, y, z)
                .setColor(255, 255, 255, 255)
                .setUv(u, v)
                .setOverlay(overlay)
                .setLight(light)
                .setNormal(n, nx, ny, nz);
    }
