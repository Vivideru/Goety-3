...
public class RoyalGuardModel<T extends Mob> extends HierarchicalModel<T> {
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (entity instanceof RoyalGuardServant royalGuard) {
            this.shield.visible = royalGuard.hasShield();
        } else if (entity instanceof ZombieRoyalGuardServant blackguard) {
            this.shield.visible = blackguard.hasShield();
        } else {
