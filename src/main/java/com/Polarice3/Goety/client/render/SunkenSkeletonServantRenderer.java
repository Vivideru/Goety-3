...
public class SunkenSkeletonServantRenderer extends HumanoidMobRenderer<SunkenSkeletonServant, SunkenSkeletonModel<SunkenSkeletonServant>> {
   ...
   protected void setupRotations(SunkenSkeletonServant p_114109_, PoseStack p_114110_, float p_114111_, float p_114112_, float p_114113_, float pScale) {
      super.setupRotations(p_114109_, p_114110_, p_114111_, p_114112_, p_114113_, pScale);
