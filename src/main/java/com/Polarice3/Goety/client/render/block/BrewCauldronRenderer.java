...
public class BrewCauldronRenderer implements BlockEntityRenderer<BrewCauldronBlockEntity> {
    public static final ResourceLocation WATER = ResourceLocation.parse("block/water_still");
                ...
                if (entity.isHeated() && !Minecraft.getInstance().isPaused()) {
                    ...
                    if (fluidHeight > 0) {
                        ...
                        if (entity.mode == BrewCauldronBlockEntity.Mode.BREWING) {
                            ...
                            world.addParticle(ColorParticleOption.create(ParticleTypes.ENTITY_EFFECT, entity.getColor()), pos.getX() + 0.5, pos.getY() + fluidHeight, pos.getZ() + 0.5, 0.0D, 0.0D, 0.0D);
