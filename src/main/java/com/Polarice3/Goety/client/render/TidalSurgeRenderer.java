...
public class TidalSurgeRenderer<T extends AbstractWave> extends EntityRenderer<T> {
    ...
    public void render(T entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
        ...
        this.model.renderToBuffer(matrixStackIn, waveConsumer, packedLightIn, OverlayTexture.NO_OVERLAY, FastColor.ARGB32.color(255, (int)(color[0] * 255.0F), (int)(color[1] * 255.0F), (int)(color[2] * 255.0F)));
        ...
        this.model.renderToBuffer(matrixStackIn, overlayConsumer, packedLightIn, OverlayTexture.NO_OVERLAY, FastColor.ARGB32.color(255, (int)(overlayColor[0] * 255.0F), (int)(overlayColor[1] * 255.0F), (int)(overlayColor[2] * 255.0F)));
