...
/*        if (pEntity instanceof LocalPlayer player){
        ...
        if (pEntity.getVehicle() != null){
            if (pEntity.getVehicle().isAlive() && pEntity.getVehicle() instanceof LivingEntity livingEntity) {
                float f8 = livingEntity.walkAnimation.speed(Minecraft.getInstance().getTimer().getGameTimeDeltaPartialTick(false));
                float f5 = livingEntity.walkAnimation.position(Minecraft.getInstance().getTimer().getGameTimeDeltaPartialTick(false));
