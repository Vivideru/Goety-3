...
public class LichCuriosLayer<T extends LivingEntity, M extends EntityModel<T>> extends
    ...
    @Override
    public void render(@NotNull PoseStack matrixStack, @NotNull MultiBufferSource renderTypeBuffer,
                       int light, @NotNull T livingEntity, float limbSwing, float limbSwingAmount,
