...
public class BlossomThornRenderer extends EntityRenderer<BlossomThorn> {
    ...
    private void renderBeam(BlossomThorn blossomThorn, float tickDelta, PoseStack poseStack, MultiBufferSource bufferSource, RenderType type){
        ...
        vertex(vertexConsumer, matrix4f, entry, af, spikeHeight, ag, red, green, blue, c0, 0.0f);
        vertex(vertexConsumer, matrix4f, entry, af, 0.0f, ag, red, green, blue, c0, 1.0f);
        vertex(vertexConsumer, matrix4f, entry, ah, 0.0f, ai, red, green, blue, c2, 1.0f);
        vertex(vertexConsumer, matrix4f, entry, ah, spikeHeight, ai, red, green, blue, c2, 0.0f);
        vertex(vertexConsumer, matrix4f, entry, aj, spikeHeight, ak, red, green, blue, c1, 0.0f);
        vertex(vertexConsumer, matrix4f, entry, aj, 0.0f, ak, red, green, blue, c1, 1.0f);
        vertex(vertexConsumer, matrix4f, entry, al, 0.0f, am, red, green, blue, c0, 1.0f);
        vertex(vertexConsumer, matrix4f, entry, al, spikeHeight, am, red, green, blue, c0, 0.0f);
        poseStack.popPose();
    }

    public static void vertex(VertexConsumer vertexConsumer, Matrix4f matrix4f, PoseStack.Pose pose, float f, float g, float h, int red, int green, int blue, float l, float m) {
