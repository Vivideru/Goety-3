...
public class NightBeaconRenderer implements BlockEntityRenderer<NightBeaconBlockEntity> {
    ...
    private static void renderPart(PoseStack poseStack, VertexConsumer vertexConsumer, float alpha, int p_112162_, int p_112163_, float p_112164_, float p_112165_, float p_112166_, float p_112167_, float p_112168_, float p_112169_, float p_112170_, float p_112171_, float p_112172_, float p_112173_, float p_112174_, float p_112175_) {
        ...
        renderQuad(matrix4f, posestack$pose, vertexConsumer, alpha, p_112162_, p_112163_, p_112164_, p_112165_, p_112166_, p_112167_, p_112172_, p_112173_, p_112174_, p_112175_);
        renderQuad(matrix4f, posestack$pose, vertexConsumer, alpha, p_112162_, p_112163_, p_112170_, p_112171_, p_112168_, p_112169_, p_112172_, p_112173_, p_112174_, p_112175_);
        renderQuad(matrix4f, posestack$pose, vertexConsumer, alpha, p_112162_, p_112163_, p_112166_, p_112167_, p_112170_, p_112171_, p_112172_, p_112173_, p_112174_, p_112175_);
        renderQuad(matrix4f, posestack$pose, vertexConsumer, alpha, p_112162_, p_112163_, p_112168_, p_112169_, p_112164_, p_112165_, p_112172_, p_112173_, p_112174_, p_112175_);
    }

    private static void renderQuad(Matrix4f p_112120_, PoseStack.Pose p_112121_, VertexConsumer p_112122_, float alpha, int p_112127_, int p_112128_, float p_112129_, float p_112130_, float p_112131_, float p_112132_, float p_112133_, float p_112134_, float p_112135_, float p_112136_) {
    ...
    private static void addVertex(Matrix4f p_112107_, PoseStack.Pose p_112108_, VertexConsumer p_112109_, float alpha, int p_112114_, float p_112115_, float p_112116_, float p_112117_, float p_112118_) {
        p_112109_.addVertex(p_112107_, p_112115_, (float)p_112114_, p_112116_).setColor(1.0F, 1.0F, 1.0F, alpha).setUv(p_112117_, p_112118_).setOverlay(OverlayTexture.NO_OVERLAY).setLight(15728880).setNormal(p_112108_, 0.0F, 1.0F, 0.0F);
    }
