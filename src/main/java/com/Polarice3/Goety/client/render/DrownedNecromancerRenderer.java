...
public class DrownedNecromancerRenderer extends MobRenderer<DrownedNecromancer, DrownedNecromancerModel<DrownedNecromancer>> {
   ...
   protected void setupRotations(DrownedNecromancer p_114109_, PoseStack p_114110_, float p_114111_, float p_114112_, float p_114113_, float p_345095_) {
      super.setupRotations(p_114109_, p_114110_, p_114111_, p_114112_, p_114113_, p_345095_);
