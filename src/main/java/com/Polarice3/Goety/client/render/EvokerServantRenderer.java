...
import com.Polarice3.Goety.common.entities.ally.illager.EvokerServant;
...
public class EvokerServantRenderer<T extends EvokerServant> extends MobRenderer<T, IllagerServantModel<T>> {
    ...
    protected static final ResourceLocation ORIGINAL = ResourceLocation.parse("textures/entity/illager/evoker.png");
