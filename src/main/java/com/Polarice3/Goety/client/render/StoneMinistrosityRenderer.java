...
public class StoneMinistrosityRenderer<T extends StoneMinistrosity> extends MobRenderer<T, MinistrosityModel<T>> {
    private static final ResourceLocation TEXTURE_LOCATION = Goety.location("textures/entity/servants/ministrosity/stone.png");

    public StoneMinistrosityRenderer(EntityRendererProvider.Context p_i47208_1_) {
