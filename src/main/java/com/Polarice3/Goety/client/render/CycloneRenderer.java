...
public class CycloneRenderer extends EntityRenderer<Cyclone> {
    private static final ResourceLocation TEXTURES = ResourceLocation.fromNamespaceAndPath(Goety.MOD_ID, "textures/entity/projectiles/cyclone.png");
    ...
    public void render(Cyclone entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
        ...
        this.model.renderToBuffer(matrixStackIn, ivertexbuilder, packedLightIn, OverlayTexture.NO_OVERLAY, 0x73FFFFFF);
