...
public class ModDragonFireballRenderer extends EntityRenderer<ModDragonFireball> {
   ...
   private static void vertex(VertexConsumer p_254095_, Matrix4f p_254477_, PoseStack.Pose p_253948_, int p_253829_, float p_253995_, int p_254031_, int p_253641_, int p_254243_) {
      p_254095_.addVertex(p_254477_, p_253995_ - 0.5F, (float)p_254031_ - 0.25F, 0.0F).setColor(-1).setUv((float)p_253641_, (float)p_254243_).setOverlay(OverlayTexture.NO_OVERLAY).setLight(p_253829_).setNormal(0.0F, 1.0F, 0.0F);
   }
