...
public class GnasherRenderer extends MobRenderer<Gnasher, GnasherModel<Gnasher>> {
    ...
    protected void setupRotations(Gnasher p_115828_, PoseStack p_115829_, float p_115830_, float p_115831_, float p_115832_, float pScale) {
        super.setupRotations(p_115828_, p_115829_, p_115830_, p_115831_, p_115832_, pScale);
        float f = 1.0F;
        float f1 = 1.0F;
