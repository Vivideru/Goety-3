...
public class PlushieModel extends SkullModelBase {
    ...
    public void renderToBuffer(PoseStack pMatrixStack, VertexConsumer pBuffer, int pPackedLight, int pPackedOverlay, int color) {
        this.root.render(pMatrixStack, pBuffer, pPackedLight, pPackedOverlay, color);
    }
}
