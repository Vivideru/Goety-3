...
public class EnviokerModel<T extends AbstractIllager> extends HumanoidModel<T> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition clothes = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(0, 92)
            .addBox(-4.0F, -10.5F, -3.0F, 8.0F, 21.0F, 6.0F, new CubeDeformation(0.5F))
            .texOffs(0, 38)
            .addBox(-4.0F, -10.5F, -3.0F, 8.0F, 21.0F, 6.0F, new CubeDeformation(0.25F)),
      ...
      PartDefinition arms = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(1, 83)
            .addBox(-10.05F, -0.25F, -3.0F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
            .texOffs(1, 83)
            .mirror()
            .addBox(4.05F, -0.25F, -3.0F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
            .mirror(false)
            .texOffs(39, 62)
            .addBox(-9.5F, -1.5F, -2.5F, 4.0F, 7.0F, 5.0F, new CubeDeformation(0.0F))
            .texOffs(39, 62)
            .mirror()
            .addBox(5.5F, -1.5F, -2.5F, 4.0F, 7.0F, 5.0F, new CubeDeformation(0.0F))
            .mirror(false)
            .texOffs(44, 22)
            .mirror()
            ...
            .mirror(false)
            .texOffs(1, 75)
            .addBox(-10.05F, -2.25F, -3.0F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
            .texOffs(1, 75)
            .mirror()
            .addBox(4.05F, -2.25F, -3.0F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
            .mirror(false)
            .texOffs(40, 38)
      ...
      PartDefinition right_arm = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(40, 46)
            .addBox(-3.05F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(1, 83)
            .addBox(-5.0F, -0.25F, -3.0F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
            .texOffs(1, 75)
            .addBox(-5.0F, -2.25F, -3.0F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
            .texOffs(39, 62)
            .addBox(-4.5F, -1.5F, -2.5F, 4.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)),
      ...
      PartDefinition left_arm = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(40, 46)
            .mirror()
            .addBox(-0.95F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
            .mirror(false)
            .texOffs(1, 75)
            .mirror()
            .addBox(-1.0F, -2.25F, -3.0F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
            .mirror(false)
            .texOffs(1, 83)
            .mirror()
            .addBox(-1.0F, -0.25F, -3.0F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
            .mirror(false)
            .texOffs(39, 62)
            .mirror()
            .addBox(0.5F, -1.5F, -2.5F, 4.0F, 7.0F, 5.0F, new CubeDeformation(0.0F))
            .mirror(false),
         PartPose.offset(5.0F, 2.0F, 0.0F)
      );
   ...
   public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      IllagerArmPose armPose = entity.getArmPose();
      switch (armPose) {
         case CROSSED:
      ...
      boolean crossed = armPose == IllagerArmPose.CROSSED;
      this.arms.visible = crossed;
      this.leftArm.visible = !crossed;
      this.rightArm.visible = !crossed;
      boolean armoredBody = entity.getItemBySlot(EquipmentSlot.CHEST).getItem() instanceof ArmorItem
         || entity.getItemBySlot(EquipmentSlot.LEGS).getItem() instanceof ArmorItem;
      this.clothes.visible = !armoredBody;
      this.hat.visible = !(entity.getItemBySlot(EquipmentSlot.HEAD).getItem() instanceof ArmorItem);
   }
   ...
   public void prepareMobModel(T entity, float limbSwing, float limbSwingAmount, float partialTick) {
      ...
      if (entity.getMainArm() == HumanoidArm.RIGHT) {
         setArmPose(InteractionHand.MAIN_HAND, entity, true);
         setArmPose(InteractionHand.OFF_HAND, entity, false);
      } else {
         setArmPose(InteractionHand.OFF_HAND, entity, true);
         setArmPose(InteractionHand.MAIN_HAND, entity, false);
      }
      super.prepareMobModel(entity, limbSwing, limbSwingAmount, partialTick);
   }

   private void setArmPose(InteractionHand hand, T entity, boolean right) {
      ItemStack stack = entity.getItemInHand(hand);
      if (entity.getArmPose() != IllagerArmPose.CROSSED) {
         if (right) {
            this.rightArmPose = stack.isEmpty() ? ArmPose.EMPTY : ArmPose.ITEM;
         } else {
            this.leftArmPose = stack.isEmpty() ? ArmPose.EMPTY : ArmPose.ITEM;
         }
      }
   }
