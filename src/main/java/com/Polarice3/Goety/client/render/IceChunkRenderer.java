...
public class IceChunkRenderer extends EntityRenderer<IceChunk> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Goety.MOD_ID, "textures/entity/projectiles/ice_chunk.png");
    private static final ResourceLocation SPAWN = ResourceLocation.fromNamespaceAndPath(Goety.MOD_ID, "textures/entity/projectiles/ice_chunk_spawn.png");
