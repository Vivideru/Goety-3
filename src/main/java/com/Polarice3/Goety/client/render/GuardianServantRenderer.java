...
public class GuardianServantRenderer extends MobRenderer<GuardianServant, GuardianServantModel> {
   private static final ResourceLocation GUARDIAN_LOCATION = ResourceLocation.parse("textures/entity/guardian.png");
   private static final ResourceLocation SERVANT_LOCATION = Goety.location("textures/entity/servants/guardian_servant.png");
   private static final ResourceLocation GUARDIAN_BEAM_LOCATION = ResourceLocation.parse("textures/entity/guardian_beam.png");
   ...
   public void render(GuardianServant p_114829_, float p_114830_, float p_114831_, PoseStack p_114832_, MultiBufferSource p_114833_, int p_114834_) {
      ...
      if (livingentity != null) {
         ...
         vertex(vertexconsumer, matrix4f, posestack$pose, f19, f4, f20, j, k, l, 0.4999F, f30);
         vertex(vertexconsumer, matrix4f, posestack$pose, f19, 0.0F, f20, j, k, l, 0.4999F, f29);
         vertex(vertexconsumer, matrix4f, posestack$pose, f21, 0.0F, f22, j, k, l, 0.0F, f29);
         vertex(vertexconsumer, matrix4f, posestack$pose, f21, f4, f22, j, k, l, 0.0F, f30);
         vertex(vertexconsumer, matrix4f, posestack$pose, f23, f4, f24, j, k, l, 0.4999F, f30);
         vertex(vertexconsumer, matrix4f, posestack$pose, f23, 0.0F, f24, j, k, l, 0.4999F, f29);
         vertex(vertexconsumer, matrix4f, posestack$pose, f25, 0.0F, f26, j, k, l, 0.0F, f29);
         vertex(vertexconsumer, matrix4f, posestack$pose, f25, f4, f26, j, k, l, 0.0F, f30);
         float f31 = 0.0F;
         if (p_114829_.tickCount % 2 == 0) {
            f31 = 0.5F;
         }

         vertex(vertexconsumer, matrix4f, posestack$pose, f11, f4, f12, j, k, l, 0.5F, f31 + 0.5F);
         vertex(vertexconsumer, matrix4f, posestack$pose, f13, f4, f14, j, k, l, 1.0F, f31 + 0.5F);
         vertex(vertexconsumer, matrix4f, posestack$pose, f17, f4, f18, j, k, l, 1.0F, f31);
         vertex(vertexconsumer, matrix4f, posestack$pose, f15, f4, f16, j, k, l, 0.5F, f31);
         p_114832_.popPose();
      }
