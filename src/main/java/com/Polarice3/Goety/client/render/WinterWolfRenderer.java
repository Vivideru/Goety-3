...
public class WinterWolfRenderer extends MobRenderer<WinterWolf, BlackWolfModel<WinterWolf>> {
    private static final ResourceLocation TEXTURES = Goety.location("textures/entity/servants/black_wolf/winter_wolf.png");

    public WinterWolfRenderer(EntityRendererProvider.Context p_174452_) {
    ...
    @Override
    protected void scale(WinterWolf p_115314_, PoseStack p_115315_, float p_115316_) {
        int i = p_115314_.isUpgraded() ? 1 : 0;
        float f = 1.0F + 0.15F * (float)i;
        p_115315_.scale(f, f, f);
    }

    protected float getBob(WinterWolf p_116528_, float p_116529_) {
        return p_116528_.getTailAngle();
    }

    public void render(WinterWolf p_116531_, float p_116532_, float p_116533_, PoseStack p_116534_, MultiBufferSource p_116535_, int p_116536_) {
        if (p_116531_.isWet()) {
    ...
    public ResourceLocation getTextureLocation(WinterWolf p_116526_) {
        return TEXTURES;
    }

    public static class ChainsLayer<T extends WinterWolf, M extends BlackWolfModel<T>> extends RenderLayer<T, M> {
    ...
    public static class BigFurLayer<T extends WinterWolf, M extends BlackWolfModel<T>> extends RenderLayer<T, M> {
        private static final ResourceLocation TEXTURES = Goety.location("textures/entity/servants/black_wolf/winter_wolf_fur.png");
    ...
    public static class WolfEyesLayer<T extends WinterWolf, M extends BlackWolfModel<T>> extends EyesLayer<T, M> {
        private static final ResourceLocation TEXTURES = Goety.location("textures/entity/servants/black_wolf/winter_wolf_eyes.png");
