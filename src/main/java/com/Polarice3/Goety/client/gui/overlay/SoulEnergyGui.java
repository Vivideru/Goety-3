    ...
    public static void drawHUD(GuiGraphics guiGraphics, DeltaTracker deltaTracker) {
        ...
        if (SEHelper.getSEActive(minecraft.player)){
            ...
            if (customData != null) {
                ...
                if (customData.contains(ITotem.MAX_SOUL_AMOUNT)) {
        ...
        RenderSystem.setShaderTexture(0, ResourceLocation.fromNamespaceAndPath(Goety.MOD_ID, "textures/gui/soul_energy_bar.png"));
        ...
        if (MobUtil.isSpellCasting(minecraft.player)){
            int useDuration = minecraft.player.getUseItem().getUseDuration(minecraft.player);
            ...
            if (WandUtil.getSpell(minecraft.player) instanceof IChargingSpell spell){
                if (WandUtil.getShots(minecraft.player) > 0 && spell.shotsNumber(minecraft.player, minecraft.player.getUseItem()) > 0){
                    ...
                    remain = minecraft.player.getUseItem().getUseDuration(minecraft.player) - minecraft.player.getUseItemRemainingTicks();
                    useTime0 = remain / useDuration;
                }
            }
