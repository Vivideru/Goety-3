...
public class RisingCircleParticleOption implements ParticleOptions {
   ...
   public static final StreamCodec<RegistryFriendlyByteBuf, RisingCircleParticleOption> STREAM_CODEC = StreamCodec.of(
           ...
           RisingCircleParticleOption::fromNetwork
   );

   private static RisingCircleParticleOption fromNetwork(RegistryFriendlyByteBuf buffer) {
         return new RisingCircleParticleOption(buffer.readVarInt());
   }
