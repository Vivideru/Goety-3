...
public class FoggyCloudParticle extends GroundCircleParticle{
    ...
    public void makeCornerVertex(VertexConsumer pConsumer, Vector3f pVec3f, float p_233996_, float p_233997_, int p_233998_) {
        ...
        pConsumer.addVertex((float)(pVec3f.x() + wiggle.x), pVec3f.y() + 0.08F + alpha * 0.125F, (float)(pVec3f.z() + wiggle.z)).setUv(p_233996_, p_233997_).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setLight(p_233998_);
    }
