    ...
    public void render(VertexConsumer consumer, Camera camera, float partialTick) {
        if (this.trailPointer > -1) {
            ...
            while (samples < this.sampleSize()){
                ...
                vertexConsumer.addVertex(matrix4f, (float)draw1.x + (float)bottomAngleVec.x, (float)draw1.y + (float)bottomAngleVec.y, (float)draw1.z + (float)bottomAngleVec.z).setColor(this.rCol, this.gCol, this.bCol, this.trailA).setUv(u1, 1.0F).setOverlay(OverlayTexture.NO_OVERLAY).setLight(this.getLightColor(partialTick)).setNormal(last, 0.0F, 1.0F, 0.0F);
                vertexConsumer.addVertex(matrix4f, (float)sample.x + (float)bottomAngleVec.x, (float)sample.y + (float)bottomAngleVec.y, (float)sample.z + (float)bottomAngleVec.z).setColor(this.rCol, this.gCol, this.bCol, this.trailA).setUv(u2, 1.0F).setOverlay(OverlayTexture.NO_OVERLAY).setLight(this.getLightColor(partialTick)).setNormal(last, 0.0F, 1.0F, 0.0F);
                vertexConsumer.addVertex(matrix4f, (float)sample.x + (float)topAngleVec.x, (float)sample.y + (float)topAngleVec.y, (float)sample.z + (float)topAngleVec.z).setColor(this.rCol, this.gCol, this.bCol, this.trailA).setUv(u2, 0.0F).setOverlay(OverlayTexture.NO_OVERLAY).setLight(this.getLightColor(partialTick)).setNormal(last, 0.0F, 1.0F, 0.0F);
                vertexConsumer.addVertex(matrix4f, (float)draw1.x + (float)topAngleVec.x, (float)draw1.y + (float)topAngleVec.y, (float)draw1.z + (float)topAngleVec.z).setColor(this.rCol, this.gCol, this.bCol, this.trailA).setUv(u1, 0.0F).setOverlay(OverlayTexture.NO_OVERLAY).setLight(this.getLightColor(partialTick)).setNormal(last, 0.0F, 1.0F, 0.0F);
                ++samples;
                drawFrom = sample;
            }
