...
public class AuraParticleOption implements ParticleOptions {
    public static final MapCodec<AuraParticleOption> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, AuraParticleOption> STREAM_CODEC = StreamCodec.of(
           (buffer, option) -> option.writeToNetwork(buffer),
           AuraParticleOption::fromNetwork
   );

   private static AuraParticleOption fromNetwork(RegistryFriendlyByteBuf buffer) {
