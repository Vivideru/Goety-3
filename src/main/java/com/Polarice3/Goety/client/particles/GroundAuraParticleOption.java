...
public class GroundAuraParticleOption implements ParticleOptions {
    public static final MapCodec<GroundAuraParticleOption> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, GroundAuraParticleOption> STREAM_CODEC = StreamCodec.of(
           (buffer, option) -> option.writeToNetwork(buffer),
           GroundAuraParticleOption::fromNetwork
   );

   private static GroundAuraParticleOption fromNetwork(RegistryFriendlyByteBuf buffer) {
