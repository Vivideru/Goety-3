                ...
                if (!spawners.isEmpty()) {
                    ...
                    if (entityType != null) {
                        ...
                        if (SpawnPlacements.checkSpawnRules(entityType, pLevel, MobSpawnType.SPAWNER, above, pRandom)) {
                            ...
                            if (entity instanceof Mob mob && MobTypeHelper.getMobType(mob) == ModMobType.UNDEAD) {
                                ...
                                if (pLevel.noCollision(entity) && pLevel.isUnobstructed(entity, pLevel.getBlockState(above).getShape(pLevel, above))) {
                                    EventHooks.finalizeMobSpawn(mob, pLevel, pLevel.getCurrentDifficultyAt(pPos), MobSpawnType.SPAWNER, null);
