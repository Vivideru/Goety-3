...
public class ModSaveInventory extends SavedData {
    ...
    public static ModSaveInventory load(CompoundTag compoundTag, HolderLookup.Provider provider) {
    ...
    public static void setInstance(ServerLevel world) {
        ...
        INSTANCE = manager.computeIfAbsent(new SavedData.Factory<>(ModSaveInventory::new, ModSaveInventory::load), NAME);
    }

    public static void read(CompoundTag nbt, HolderLookup.Provider provider) {
