...
//Basically CherryTrunkPlacer without placing Dirt below the tree.
public class ChorusTrunkPlacer extends TrunkPlacer {
    public static final MapCodec<ChorusTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec((p_273579_) -> {
        ...
        }), IntProvider.codec(-16, 0).fieldOf("branch_start_offset_from_top").forGetter((p_272705_) -> {
        ...
        }))).apply(p_273579_, ChorusTrunkPlacer::new);
    });
    private final IntProvider branchCount;
    private final IntProvider branchHorizontalLength;
    private final IntProvider branchStartOffsetFromTop;
    private final IntProvider secondBranchStartOffsetFromTop;
    private final IntProvider branchEndOffsetFromTop;

    public ChorusTrunkPlacer(int p_273281_, int p_273327_, int p_272619_, IntProvider p_272873_, IntProvider p_272789_, IntProvider p_272917_, IntProvider p_272948_) {
    ...
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.CHORUS_TRUNK_PLACER.get();
    }
