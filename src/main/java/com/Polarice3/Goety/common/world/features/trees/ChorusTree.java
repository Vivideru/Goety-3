...
public class ChorusTree {
    ...
    public boolean growTree(ServerLevel p_222905_, ChunkGenerator p_222906_, BlockPos p_222907_, BlockState p_222908_, RandomSource p_222909_) {
        ...
        if (resourcekey == null) {
            ...
            var event = net.neoforged.neoforge.event.EventHooks.fireBlockGrowFeature(p_222905_, p_222909_, p_222907_, holder);
    ...
    public boolean placeMega(ServerLevel p_222897_, ChunkGenerator p_222898_, BlockPos p_222899_, BlockState p_222900_, RandomSource p_222901_, int p_222902_, int p_222903_) {
        ...
        if (resourcekey == null) {
            ...
            var event = net.neoforged.neoforge.event.EventHooks.fireBlockGrowFeature(p_222897_, p_222901_, p_222899_, holder);
            holder = event.getFeature();
            if (event.isCanceled()) return false;
            if (holder == null) {
                return false;
