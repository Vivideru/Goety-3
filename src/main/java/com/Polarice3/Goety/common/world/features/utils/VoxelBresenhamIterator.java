...
/**
 * Adapted from @TeamTwilight: <a href="https://github.com/TeamTwilight/twilightforest/blob/1.20.1/src/main/java/twilightforest/util/VoxelBresenhamIterator.java">...</a>
 */
