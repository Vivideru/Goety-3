...
public class ConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> SAPLING_HAUNTED_TREE = key("haunted_tree_sapling");
    public static final ResourceKey<ConfiguredFeature<?, ?>> SAPLING_ROTTEN_TREE = key("rotten_tree_sapling");
    public static final ResourceKey<ConfiguredFeature<?, ?>> SAPLING_FANCY_ROTTEN_TREE = key("fancy_rotten_tree_sapling");
    public static final ResourceKey<ConfiguredFeature<?, ?>> WINDSWEPT_TREE = key("windswept_tree");
    public static final ResourceKey<ConfiguredFeature<?, ?>> WINDSWEPT_TREE_2 = key("second_windswept_tree");
    public static final ResourceKey<ConfiguredFeature<?, ?>> PINE_TREE = key("pine_tree");
    public static final ResourceKey<ConfiguredFeature<?, ?>> MEGA_PINE_TREE = key("mega_pine_tree");
    public static final ResourceKey<ConfiguredFeature<?, ?>> RED_MOSS_BONEMEAL = key("red_moss_bonemeal");
    public static final ResourceKey<ConfiguredFeature<?, ?>> CHORUS_TREE = key("chorus_tree");
    public static final ResourceKey<ConfiguredFeature<?, ?>> MEGA_CHORUS_TREE = key("mega_chorus_tree");
    public static final ResourceKey<ConfiguredFeature<?, ?>> CHORUS_BLOSSOM_TREE = key("chorus_blossom_tree");
    public static final ResourceKey<ConfiguredFeature<?, ?>> MEGA_CHORUS_BLOSSOM_TREE = key("mega_chorus_blossom_tree");
    public static final ResourceKey<ConfiguredFeature<?, ?>> MEGA_CHORUS_VOID_TREE = key("mega_chorus_void_tree");
    public static final ResourceKey<ConfiguredFeature<?, ?>> MEGA_CHORUS_BLOSSOM_VOID_TREE = key("mega_chorus_blossom_void_tree");
    public static final ResourceKey<ConfiguredFeature<?, ?>> CHORUS_GRASS_BLOCK_BONEMEAL = key("chorus_grass_block_bonemeal");
    public static final ResourceKey<ConfiguredFeature<?, ?>> END_GROWTH_BLOCK_BONEMEAL = key("end_growth_block_bonemeal");
    public static final ResourceKey<ConfiguredFeature<?, ?>> END_VEGETATION_BONEMEAL = key("end_vegetation_bonemeal");
