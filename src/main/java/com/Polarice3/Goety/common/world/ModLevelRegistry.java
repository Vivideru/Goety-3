...
public class ModLevelRegistry {
    ...
    public static void addBiomeSpawns(Holder<Biome> biome, ModifiableBiomeInfo.BiomeInfo.Builder builder) {
        ...
        if (!biome.is(ModTags.Biomes.COMMON_BLACKLIST) && !biome.unwrapKey().map(biomeResourceKey -> biomeResourceKey.location().getNamespace().contains("alexscaves")).orElse(false)){
            ...
            if (biome.is(ModTags.Biomes.WRAITH_SPAWN) && !biome.is(ModTags.Biomes.WRAITH_EXCLUDE_SPAWN) && MobsConfig.WraithSpawnWeight.get() > 0){
                addSpawn(builder, ModEntityType.WRAITH.get(), MobsConfig.WraithSpawnWeight.get(), MobsConfig.WraithSpawnMinCount.get(), MobsConfig.WraithSpawnMaxCount.get());
            }
            if (biome.is(ModTags.Biomes.MUCK_WRAITH_SPAWN) && !biome.is(ModTags.Biomes.MUCK_WRAITH_EXCLUDE_SPAWN) && MobsConfig.MuckWraithSpawnWeight.get() > 0){
                addSpawn(builder, ModEntityType.MUCK_WRAITH.get(), MobsConfig.MuckWraithSpawnWeight.get(), MobsConfig.MuckWraithSpawnMinCount.get(), MobsConfig.MuckWraithSpawnMaxCount.get());
            }
            if (biome.is(ModTags.Biomes.WEB_SPIDER_SPAWN) && !biome.is(ModTags.Biomes.WEB_SPIDER_EXCLUDE_SPAWN) && MobsConfig.WebSpiderSpawnWeight.get() > 0){
                addSpawn(builder, ModEntityType.WEB_SPIDER.get(), MobsConfig.WebSpiderSpawnWeight.get(), MobsConfig.WebSpiderSpawnMinCount.get(), MobsConfig.WebSpiderSpawnMaxCount.get());
            }
            if (biome.is(ModTags.Biomes.ICY_SPIDER_SPAWN) && !biome.is(ModTags.Biomes.ICY_SPIDER_EXCLUDE_SPAWN) && MobsConfig.IcySpiderSpawnWeight.get() > 0){
                addSpawn(builder, ModEntityType.ICY_SPIDER.get(), MobsConfig.IcySpiderSpawnWeight.get(), MobsConfig.IcySpiderSpawnMinCount.get(), MobsConfig.IcySpiderSpawnMaxCount.get());
            }
            if (biome.is(ModTags.Biomes.FRAYED_SPAWN) && !biome.is(ModTags.Biomes.FRAYED_EXCLUDE_SPAWN) && MobsConfig.FrayedSpawnWeight.get() > 0){
                addSpawn(builder, ModEntityType.FRAYED.get(), MobsConfig.FrayedSpawnWeight.get(), MobsConfig.FrayedSpawnMinCount.get(), MobsConfig.FrayedSpawnMaxCount.get());
            }
            if (biome.is(ModTags.Biomes.RATTLED_SPAWN) && !biome.is(ModTags.Biomes.RATTLED_EXCLUDE_SPAWN) && MobsConfig.RattledSpawnWeight.get() > 0){
                addSpawn(builder, ModEntityType.RATTLED.get(), MobsConfig.RattledSpawnWeight.get(), MobsConfig.RattledSpawnMinCount.get(), MobsConfig.RattledSpawnMaxCount.get());
            }
            if (biome.is(ModTags.Biomes.NECROMANCER_SPAWN) && !biome.is(ModTags.Biomes.NECROMANCER_EXCLUDE_SPAWN) && MobsConfig.NecromancerSpawnWeight.get() > 0){
                addSpawn(builder, ModEntityType.NECROMANCER.get(), MobsConfig.NecromancerSpawnWeight.get(), MobsConfig.NecromancerSpawnMinCount.get(), MobsConfig.NecromancerSpawnMaxCount.get());
            }
            if (biome.is(ModTags.Biomes.WARLOCK_SPAWN) && !biome.is(ModTags.Biomes.WARLOCK_EXCLUDE_SPAWN) && MobsConfig.WarlockSpawnWeight.get() > 0){
                addSpawn(builder, ModEntityType.WARLOCK.get(), MobsConfig.WarlockSpawnWeight.get(), MobsConfig.WarlockSpawnMinCount.get(), MobsConfig.WarlockSpawnMaxCount.get());
            }
            if (biome.is(ModTags.Biomes.HERETIC_SPAWN) && !biome.is(ModTags.Biomes.HERETIC_EXCLUDE_SPAWN) && MobsConfig.HereticSpawnWeight.get() > 0){
                addSpawn(builder, ModEntityType.HERETIC.get(), MobsConfig.HereticSpawnWeight.get(), MobsConfig.HereticSpawnMinCount.get(), MobsConfig.HereticSpawnMaxCount.get());
            }
            if (biome.is(ModTags.Biomes.MAVERICK_SPAWN) && !biome.is(ModTags.Biomes.MAVERICK_EXCLUDE_SPAWN) && MobsConfig.MaverickSpawnWeight.get() > 0){
                addSpawn(builder, ModEntityType.MAVERICK.get(), MobsConfig.MaverickSpawnWeight.get(), MobsConfig.MaverickSpawnMinCount.get(), MobsConfig.MaverickSpawnMaxCount.get());
            }
            if (biome.is(ModTags.Biomes.REPROBATE_SPAWN) && !biome.is(ModTags.Biomes.REPROBATE_EXCLUDE_SPAWN) && MobsConfig.ReprobateSpawnWeight.get() > 0){
                addSpawn(builder, ModEntityType.REPROBATE.get(), MobsConfig.ReprobateSpawnWeight.get(), MobsConfig.ReprobateSpawnMinCount.get(), MobsConfig.ReprobateSpawnMaxCount.get());
            }
        }
        if (biome.is(Biomes.SOUL_SAND_VALLEY) || biome.is(ResourceLocation.fromNamespaceAndPath("netherexp", "black_ice_glaciers"))){
    ...
    public static boolean startName(ResourceKey<Biome> biomeResourceKey, String string){
        return biomeResourceKey.location().getNamespace().startsWith(string);
    }

    public static boolean containsName(ResourceKey<Biome> biomeResourceKey, String string){
        return biomeResourceKey.location().getNamespace().contains(string);
    }
