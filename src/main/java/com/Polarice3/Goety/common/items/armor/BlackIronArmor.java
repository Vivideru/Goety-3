...
public class BlackIronArmor extends ArmorItem implements ISoulDiscount, IPersist {
    ...
    public BlackIronArmor(ArmorItem.Type p_40387_) {
        super(ModArmorMaterials.BLACK_IRON, p_40387_, ModArmorMaterials.durability(ModArmorMaterials.BLACK_IRON, p_40387_, ModItems.baseProperties()));
        this.type = p_40387_;
    }

    @Override
    public int getMaxDamage(ItemStack stack) {
        return ModArmorMaterials.configuredDurability(this.type, ItemConfig.BlackIronDurability, 30);
    }
    ...
    public net.minecraft.resources.ResourceLocation getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, net.minecraft.world.item.ArmorMaterial.Layer layer, boolean innerModel) {
        if (slot == EquipmentSlot.LEGS) {
            return Goety.location("textures/models/armor/black_iron_armor_layer.png");
        } else {
            return Goety.location("textures/models/armor/black_iron_armor.png");
        }
    }
