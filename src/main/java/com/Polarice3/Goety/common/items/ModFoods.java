...
public class ModFoods {
    public static final FoodProperties HENBANE = (new FoodProperties.Builder())
            ...
            .effect(() -> new MobEffectInstance(GoetyEffects.SUN_ALLERGY, 900, 0), 1.0F)
    ...
    public static final FoodProperties NIGHTSHADE = (new FoodProperties.Builder())
            ...
            .effect(() -> new MobEffectInstance(GoetyEffects.TRIPPING, 1200, 0), 1.0F)
            .effect(() -> new MobEffectInstance(GoetyEffects.FLAMMABLE, 1200, 0), 1.0F)
