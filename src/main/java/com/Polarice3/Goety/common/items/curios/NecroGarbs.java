        ...
        public Multimap<Holder<Attribute>, AttributeModifier> getAttributeModifiers(SlotContext slotContext,
            ...
            if (IronLoaded.IRON_SPELLBOOKS.isLoaded()){
                if (MainConfig.RobesIronResist.get()) {
                    map.put(IronAttributes.holder(IronAttributes.BLOOD_MAGIC_RESIST), com.Polarice3.Goety.utils.ModAttributeUtil.create(UUID.fromString("491b09e2-380d-49ce-b7e3-7512180c3eb0"), "Robes Iron Spell Resist", 0.25F, AttributeModifier.Operation.ADD_VALUE));
                }
            }
            return map;
        }
