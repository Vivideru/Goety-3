...
public class RaidingHorn extends Item {
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level worldIn, LivingEntity entityLiving) {
        ...
        if (worldIn instanceof ServerLevel serverWorld){
            ...
            entityLiving.playSound(SoundEvents.RAID_HORN.value(), 16.0F, 1.0F);
            serverWorld.playSound(null, entityLiving.blockPosition(), SoundEvents.RAID_HORN.value(), SoundSource.NEUTRAL, 16.0F, 1.0F);
