        ...
        if (IronLoaded.IRON_SPELLBOOKS.isLoaded()){
            if (MainConfig.RobesIronResist.get()) {
                if (stack.is(ModItems.STORM_ROBE.get())){
                    map.put(IronAttributes.holder(IronAttributes.LIGHTNING_MAGIC_RESIST), com.Polarice3.Goety.utils.ModAttributeUtil.create(UUID.fromString("ed6bb7e0-c849-4e25-849a-e288e2b76961"), "Robes Iron Spell Resist", 0.5F, AttributeModifier.Operation.ADD_VALUE));
                }
            }
        }
        return map;
