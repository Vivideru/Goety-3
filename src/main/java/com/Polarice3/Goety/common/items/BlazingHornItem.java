...
public class BlazingHornItem extends Item {
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level worldIn, LivingEntity entityLiving) {
        ...
        if (worldIn instanceof ServerLevel serverWorld){
            ...
            if (flag){
                entityLiving.playSound(SoundEvents.GOAT_HORN_SOUND_VARIANTS.get(6).value(), 16.0F, 1.0F);
                serverWorld.playSound(null, entityLiving.blockPosition(), SoundEvents.GOAT_HORN_SOUND_VARIANTS.get(6).value(), SoundSource.NEUTRAL, 16.0F, 1.0F);
                ...
                if (necromancer != null) {
                    ...
                    necromancer.finalizeSpawn(serverWorld, serverWorld.getCurrentDifficultyAt(entityLiving.blockPosition()), MobSpawnType.MOB_SUMMONED, null);
