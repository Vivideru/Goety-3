...
public class CursedKnightArmor extends ArmorItem implements IPersist {
    ...
    public CursedKnightArmor(ArmorItem.Type p_40387_) {
        super(ModArmorMaterials.CURSED_KNIGHT, p_40387_, ModArmorMaterials.durability(ModArmorMaterials.CURSED_KNIGHT, p_40387_, ModItems.baseProperties()));
        this.type = p_40387_;
    }

    @Override
    public int getMaxDamage(ItemStack stack) {
        return ModArmorMaterials.configuredDurability(this.type, ItemConfig.CursedKnightDurability, 15);
    }
    ...
    public <T extends LivingEntity> int damageItem(ItemStack stack, int amount, T entity, Consumer<net.minecraft.world.item.Item> onBroken) {
        ...
        if (ItemConfig.CursedKnightPersist.get()) {
    ...
    public boolean isBroken(ItemStack stack) {
        return IPersist.super.isBroken(stack) && ItemConfig.CursedKnightPersist.get();
    }

    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlot slot, ItemStack stack) {
        if (this.isNotBroken(stack) || !ItemConfig.CursedKnightPersist.get()) {
    ...
    public net.minecraft.resources.ResourceLocation getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, net.minecraft.world.item.ArmorMaterial.Layer layer, boolean innerModel) {
        if (slot == EquipmentSlot.LEGS) {
            return Goety.location("textures/models/armor/cursed_knight_armor_layer.png");
        } else {
            return Goety.location("textures/models/armor/cursed_knight_armor.png");
        }
    }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flagIn) {
        ...
        if (ItemConfig.CursedKnightPersist.get() && this.isBroken(stack)) {
