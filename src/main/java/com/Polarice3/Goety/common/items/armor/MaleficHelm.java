...
public class MaleficHelm extends ArmorItem implements ISoulDiscount, IPersist {

    public MaleficHelm() {
        super(ModArmorMaterials.MALEFIC, Type.HELMET, ModArmorMaterials.durability(ModArmorMaterials.MALEFIC, Type.HELMET, ModItems.baseProperties()));
    }

    @Override
    public int getMaxDamage(ItemStack stack) {
        return ModArmorMaterials.configuredDurability(Type.HELMET, ItemConfig.MaleficDurability, 30);
    }
    ...
    public net.minecraft.resources.ResourceLocation getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, net.minecraft.world.item.ArmorMaterial.Layer layer, boolean innerModel) {
        return Goety.location("textures/models/armor/malefic_helm.png");
    }
