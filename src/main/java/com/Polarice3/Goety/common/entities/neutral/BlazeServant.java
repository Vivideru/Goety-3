...
public class BlazeServant extends Summoned implements IMobTyped {
    ...
    public static AttributeSupplier.Builder setCustomAttributes(){
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.BlazeServantHealth))
                .add(Attributes.ATTACK_DAMAGE, AttributesConfig.get(AttributesConfig.BlazeServantMeleeDamage))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.BlazeServantArmor))
    ...
    public void setConfigurableAttributes() {
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.BlazeServantHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), AttributesConfig.get(AttributesConfig.BlazeServantMeleeDamage));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.BlazeServantArmor));
    }
                ...
                if (d0 < 4.0D) {
                    ...
                    if (this.attackTime <= 0) {
                        ...
                        if (this.attackStep > 1) {
                            ...
                            float damage = MobUtil.getSpecialAttackDamage(this.blaze, AttributesConfig.get(AttributesConfig.BlazeServantRangeDamage).floatValue() + this.blaze.getFireBallDamage());
