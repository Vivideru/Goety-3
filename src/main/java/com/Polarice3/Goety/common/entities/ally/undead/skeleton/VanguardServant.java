...
public class VanguardServant extends AbstractSkeletonServant {
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.VanguardServantHealth))
                .add(Attributes.MOVEMENT_SPEED, 0.25F)
                .add(Attributes.ATTACK_DAMAGE, AttributesConfig.get(AttributesConfig.VanguardServantDamage))
    ...
    public void setConfigurableAttributes(){
        ...
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.VanguardServantArmor));
    }
    ...
    public int getSummonLimit(LivingEntity owner) {
        return SpellConfig.get(SpellConfig.VanguardLimit);
    }
