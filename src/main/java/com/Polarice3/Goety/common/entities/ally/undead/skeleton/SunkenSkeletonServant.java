...
public class SunkenSkeletonServant extends AbstractSkeletonServant implements CrossbowAttackMob {
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.SunkenSkeletonServantHealth))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.SunkenSkeletonServantArmor))
                .add(Attributes.MOVEMENT_SPEED, 0.25F)
                .add(Attributes.ATTACK_DAMAGE, AttributesConfig.get(AttributesConfig.SunkenSkeletonServantDamage));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.SunkenSkeletonServantHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.SunkenSkeletonServantArmor));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), AttributesConfig.get(AttributesConfig.SunkenSkeletonServantDamage));
    }

    public double getBaseRangeDamage(){
        return AttributesConfig.get(AttributesConfig.SunkenSkeletonServantRangeDamage);
    }
