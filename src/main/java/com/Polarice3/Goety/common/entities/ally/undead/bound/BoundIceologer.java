...
public class BoundIceologer extends AbstractBoundIllager{
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Monster.createMonsterAttributes()
                ...
                .add(Attributes.FOLLOW_RANGE, AttributesConfig.get(AttributesConfig.BoundIceologerFollowRange))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.BoundIceologerArmor))
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.BoundIceologerHealth));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.BoundIceologerHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.BoundIceologerArmor));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.FOLLOW_RANGE), AttributesConfig.get(AttributesConfig.BoundIceologerFollowRange));
    }
