...
public class BoundEvoker extends AbstractBoundIllager{
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Monster.createMonsterAttributes()
                ...
                .add(Attributes.FOLLOW_RANGE, AttributesConfig.get(AttributesConfig.BoundEvokerFollowRange))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.BoundEvokerArmor))
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.BoundEvokerHealth));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.BoundEvokerHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.BoundEvokerArmor));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.FOLLOW_RANGE), AttributesConfig.get(AttributesConfig.BoundEvokerFollowRange));
    }
        ...
        protected void performSpellCasting() {
            ...
            for(int i = 0; i < 3; ++i) {
                ...
                if (vex != null) {
                    ...
                    vex.setTrueOwner(MobUtil.getSummonOwner(BoundEvoker.this));
    ...
    public class EvokerWololoSpellGoal extends BoundUseSpellGoal {
        ...
        public boolean canUse() {
            if (BoundEvoker.this.getTarget() != null) {
                ...
                return false;
            } else if (!net.neoforged.neoforge.event.EventHooks.canEntityGrief(BoundEvoker.this.level(), BoundEvoker.this)) {
                return false;
            } else {
