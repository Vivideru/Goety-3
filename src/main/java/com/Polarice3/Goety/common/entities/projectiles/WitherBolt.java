...
public class WitherBolt extends SpellHurtingProjectile {
    ...
    protected void onHitEntity(EntityHitResult p_37626_) {
        ...
        if (!this.level().isClientSide) {
            float baseDamage = SpellConfig.get(SpellConfig.WitherBoltDamage).floatValue() * WandUtil.damageMultiply();
            ...
            if (entity1 instanceof LivingEntity livingentity) {
                ...
                DamageSource damageSource = entity.damageSources().indirectMagic(this, livingentity);
