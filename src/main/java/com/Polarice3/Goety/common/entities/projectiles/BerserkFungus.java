...
public class BerserkFungus extends ThrowableFungus {
    ...
    protected void onHit(HitResult p_37406_) {
        ...
        if (!this.level().isClientSide) {
            this.level().playLocalSound(this.getX(), this.getY(), this.getZ(), ModSounds.BLAST_FUNGUS_EXPLODE.get(), SoundSource.BLOCKS, 1.0F, (1.0F + (this.getRandom().nextFloat() - this.getRandom().nextFloat()) * 0.2F) * 0.7F, false);
    ...
    public void handleEntityEvent(byte p_34138_) {
        if (p_34138_ == 15) {
            ...
            this.level().playLocalSound(this.getX(), this.getY(), this.getZ(), ModSounds.BLAST_FUNGUS_EXPLODE.get(), SoundSource.BLOCKS, 1.0F, (2.0F + (this.getRandom().nextFloat() - this.getRandom().nextFloat()) * 0.2F) * 0.7F, false);
        } else {
