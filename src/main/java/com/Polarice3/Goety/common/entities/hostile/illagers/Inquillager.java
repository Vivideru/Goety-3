...
public class Inquillager extends HuntingIllagerEntity{
    ...
    public static AttributeSupplier.Builder setCustomAttributes(){
        return Mob.createMobAttributes()
                ...
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.InquillagerHealth))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.InquillagerArmor))
                .add(Attributes.MOVEMENT_SPEED, 0.35D)
                .add(Attributes.ATTACK_DAMAGE, AttributesConfig.get(AttributesConfig.InquillagerDamage));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.InquillagerHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.InquillagerArmor));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), AttributesConfig.get(AttributesConfig.InquillagerDamage));
    }
        ...
        public void tick() {
            ...
            if (livingEntity != null) {
                ...
                if (this.bombTimer >= 60) {
                    ...
                    potionentity.setItem(ModPotionUtil.setPotion(new ItemStack(Items.SPLASH_POTION), potion));
