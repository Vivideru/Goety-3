...
public class DrownedServant extends ZombieServant implements RangedAttackMob {
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.DrownedServantHealth))
                .add(Attributes.FOLLOW_RANGE, 35.0D)
                .add(Attributes.MOVEMENT_SPEED, 0.23D)
                .add(Attributes.ATTACK_DAMAGE, AttributesConfig.get(AttributesConfig.DrownedServantDamage))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.DrownedServantArmor));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.DrownedServantHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.DrownedServantArmor));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), AttributesConfig.get(AttributesConfig.DrownedServantDamage));
    }
    ...
    public void performRangedAttack(LivingEntity pTarget, float pDistanceFactor) {
        ...
        tridententity.setBaseDamage(MobUtil.getSpecialAttackDamage(this, (float)tridententity.getBaseDamage()));
