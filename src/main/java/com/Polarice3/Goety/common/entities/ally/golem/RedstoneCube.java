...
public class RedstoneCube extends AbstractGolemServant{
    ...
    public static AttributeSupplier.Builder setCustomAttributes(){
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.RedstoneCubeHealth))
    ...
    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.RedstoneCubeHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.RedstoneCubeArmor));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), AttributesConfig.get(AttributesConfig.RedstoneCubeDamage));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.FOLLOW_RANGE), AttributesConfig.get(AttributesConfig.RedstoneCubeFollowRange));
    }
            ...
            if (this.isAlive()) {
                ...
                if (this.walkAnimation.isMoving()) {
                    if (this.onGround() && this.tickCount % 5 == 0) {
                        ...
                        this.level().addParticle(ModParticleTypes.REDSTONE_DEBRIS.get(), this.getX(), this.getY() + 0.1F, this.getZ(), colorUtil.red, colorUtil.green, colorUtil.blue);
                    }
                }
            }
        }
