...
public class WitherSkeletonServant extends AbstractSkeletonServant {
   ...
   public static AttributeSupplier.Builder setCustomAttributes() {
      return Mob.createMobAttributes()
              .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.WitherSkeletonServantHealth))
              .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.WitherSkeletonServantArmor))
              .add(Attributes.MOVEMENT_SPEED, 0.25F)
              .add(Attributes.ATTACK_DAMAGE, AttributesConfig.get(AttributesConfig.WitherSkeletonServantDamage));
   }

   public void setConfigurableAttributes(){
      MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.WitherSkeletonServantHealth));
      MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.WitherSkeletonServantArmor));
      MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), AttributesConfig.get(AttributesConfig.WitherSkeletonServantDamage));
   }

   @Override
   public double getBaseRangeDamage() {
      return AttributesConfig.get(AttributesConfig.WitherSkeletonServantRangeDamage);
   }
