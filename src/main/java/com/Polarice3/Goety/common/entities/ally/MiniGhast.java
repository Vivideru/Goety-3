...
public class MiniGhast extends Malghast {
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.MiniGhastHealth))
                .add(Attributes.FOLLOW_RANGE, 32.0D);
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.MiniGhastHealth));
    }
        ...
        public void tick() {
            ...
            if (livingentity != null && livingentity.distanceToSqr(this.ghast) < Mth.square(d0) && this.ghast.hasLineOfSight(livingentity)) {
                ...
                if (this.chargeTime == 20) {
                    ...
                    fireball.setDamage(MobUtil.getSpecialAttackDamage(this.ghast, AttributesConfig.get(AttributesConfig.MiniGhastDamage).floatValue() + this.ghast.getFireBallDamage()));
