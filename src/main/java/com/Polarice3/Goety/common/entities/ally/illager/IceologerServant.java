...
public class IceologerServant extends SpellcasterIllagerServant{
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Monster.createMonsterAttributes()
                ...
                .add(Attributes.FOLLOW_RANGE, AttributesConfig.get(AttributesConfig.IceologerServantFollowRange))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.IceologerServantArmor))
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.IceologerServantHealth));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.IceologerServantHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.IceologerServantArmor));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.FOLLOW_RANGE), AttributesConfig.get(AttributesConfig.IceologerServantFollowRange));
    }
