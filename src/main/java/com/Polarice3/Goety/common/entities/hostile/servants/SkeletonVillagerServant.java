...
public class SkeletonVillagerServant extends Owned implements CrossbowAttackMob, RangedAttackMob, IMobTyped {
    ...
    public static AttributeSupplier.Builder setCustomAttributes(){
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.SkeletonVillagerServantHealth))
                .add(Attributes.ATTACK_DAMAGE, AttributesConfig.get(AttributesConfig.SkeletonVillagerServantDamage))
                .add(Attributes.MOVEMENT_SPEED, 0.25D);
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.SkeletonVillagerServantHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), AttributesConfig.get(AttributesConfig.SkeletonVillagerServantDamage));
    }
    ...
    protected void defineSynchedData(SynchedEntityData.Builder pBuilder) {
        ...
        pBuilder.define(DATA_CHARGING_STATE, false);
    }
    ...
    public boolean doHurtTarget(Entity entityIn) {
        ...
        if (flag) {
            ...
            if (this.getMainHandItem().isEmpty() && this.isOnFire() && this.random.nextFloat() < f * 0.3F) {
                entityIn.igniteForSeconds((float)(2 * (int)f));
            }
        }
    ...
    public void performRangedAttack(LivingEntity pTarget, float pDistanceFactor) {
        ...
        AbstractArrow abstractarrowentity = this.getArrow(itemstack, pDistanceFactor, weapon);
    ...
    protected AbstractArrow getArrow(ItemStack pArrowStack, float pDistanceFactor, ItemStack pWeaponStack) {
        return ProjectileUtil.getMobArrow(this, pArrowStack, pDistanceFactor, pWeaponStack);
    }
