 ...
 */
public abstract class AbstractBeam extends Entity implements IEntityWithComplexSpawn, ISpellEntity {
    ...
    public void tick() {
        ...
        if (owner != null && owner.isAlive() && SpellConfig.get(SpellConfig.CorruptionImmobile)){
