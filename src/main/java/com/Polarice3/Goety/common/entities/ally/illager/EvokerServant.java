...
public class EvokerServant extends SpellcasterIllagerServant{
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Monster.createMonsterAttributes()
                ...
                .add(Attributes.FOLLOW_RANGE, AttributesConfig.get(AttributesConfig.EvokerServantFollowRange))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.EvokerServantArmor))
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.EvokerServantHealth));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.EvokerServantHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.EvokerServantArmor));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.FOLLOW_RANGE), AttributesConfig.get(AttributesConfig.EvokerServantFollowRange));
    }
    ...
    protected ResourceKey<LootTable> getDefaultLootTable() {
        if (this.isNatural()){
            return EntityType.EVOKER.getDefaultLootTable();
        } else {
        ...
        protected void performSpellCasting() {
            ...
            for(int i = 0; i < 3; ++i) {
                ...
                if (vex != null) {
                    ...
                    vex.finalizeSpawn(serverlevel, EvokerServant.this.level().getCurrentDifficultyAt(blockpos), MobSpawnType.MOB_SUMMONED, (SpawnGroupData)null);
                    vex.setTrueOwner(MobUtil.getSummonOwner(EvokerServant.this));
    ...
    public class EvokerWololoSpellGoal extends SpellcasterUseSpellGoal {
        ...
        public boolean canUse() {
            if (EvokerServant.this.getTarget() != null) {
                ...
                return false;
            } else if (!net.neoforged.neoforge.event.EventHooks.canEntityGrief(EvokerServant.this.level(), EvokerServant.this)) {
                return false;
            } else {
