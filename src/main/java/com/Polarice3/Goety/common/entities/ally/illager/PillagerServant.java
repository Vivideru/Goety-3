...
public class PillagerServant extends AbstractIllagerServant implements CrossbowAttackMob {
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Mob.createMobAttributes()
                ...
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.PillagerServantHealth))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.PillagerServantArmor))
                .add(Attributes.ATTACK_DAMAGE, AttributesConfig.get(AttributesConfig.PillagerServantDamage))
                .add(Attributes.FOLLOW_RANGE, 32.0D);
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.PillagerServantHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.PillagerServantArmor));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), AttributesConfig.get(AttributesConfig.PillagerServantDamage));
    }

    public double getBaseRangeDamage(){
        return AttributesConfig.get(AttributesConfig.PillagerServantRangeDamage);
    }
    ...
    protected void enchantSpawnedWeapon(ServerLevelAccessor pLevel, RandomSource p_219056_, DifficultyInstance p_219057_) {
        super.enchantSpawnedWeapon(pLevel, p_219056_, p_219057_);
    ...
    public void shootCrossbowProjectile(LivingEntity p_33275_, ItemStack p_33276_, Projectile p_33277_, float p_33278_) {
        ...
        this.shootCrossbowProjectile(this, p_33276_, p_33277_, p_33278_);
    }
