...
public class VoidShockBomb extends SpellThrowableProjectile {
    ...
    public float baseDamage = SpellConfig.get(SpellConfig.VoidBombDamage).floatValue() * WandUtil.damageMultiply();
    ...
    protected void onHitEntity(EntityHitResult result) {
        ...
        if (!this.level().isClientSide && !MobUtil.areAllies(shooter, entity)) {
            ...
            if (shooter instanceof LivingEntity livingentity) {
                var damageSource = this.damageSources().indirectMagic(this, livingentity);
