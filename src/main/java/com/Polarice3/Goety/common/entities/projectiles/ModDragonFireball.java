                ...
                if (entity instanceof LivingEntity livingEntity) {
                    if (entity instanceof Player player){
                        if (WandUtil.enchantedFocus(player)){
                            radius = WandUtil.getLevels(ModEnchantments.RADIUS, player);
                            duration = WandUtil.getLevels(ModEnchantments.DURATION, player) + 1;
                            damage = WandUtil.getLevels(ModEnchantments.POTENCY, player) / 2.0F;
                        }
                    }
