...
public class MountaineerServant extends AbstractIllagerServant {
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Monster.createMonsterAttributes()
                ...
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.MountaineerServantHealth))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.MountaineerServantArmor))
                .add(Attributes.ATTACK_DAMAGE, AttributesConfig.get(AttributesConfig.MountaineerServantDamage));
    }

    public void setConfigurableAttributes() {
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.MountaineerServantHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.MountaineerServantArmor));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), AttributesConfig.get(AttributesConfig.MountaineerServantDamage));
    }
    ...
    protected ResourceKey<LootTable> getDefaultLootTable() {
        if (this.isNatural()){
            return ResourceKey.create(Registries.LOOT_TABLE, ModLootTables.NATURAL_MOUNTAINEER);
        } else {
    ...
    public boolean isClimbableBlock(BlockPos blockPos) {
        ...
        return (blockState.is(BlockTags.ICE)
                || blockState.is(Tags.Blocks.STONES)
                || blockState.is(Tags.Blocks.COBBLESTONES)
