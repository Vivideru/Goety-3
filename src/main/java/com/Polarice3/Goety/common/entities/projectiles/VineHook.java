...
public class VineHook extends Projectile {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder pBuilder) {
        pBuilder.define(ATTACHED, false);
        pBuilder.define(LENGTH, 0.0F);
    }
    ...
    public void tick() {
        ...
        if (!this.isNoGravity() && !this.isAttached()) {
            ...
            this.setDeltaMovement(vec31.x, vec31.y - (double)this.getHookGravity(), vec31.z);
        }
    ...
    @Override
    public boolean canChangeDimensions(Level pFrom, Level pTo) {
        return false;
    }
