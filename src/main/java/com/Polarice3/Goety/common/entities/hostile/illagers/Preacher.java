...
public class Preacher extends HuntingIllagerEntity{
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.PreacherHealth))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.PreacherArmor))
                .add(Attributes.FOLLOW_RANGE, 16.0D)
                .add(Attributes.MOVEMENT_SPEED, 0.35D);
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.PreacherHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.PreacherArmor));
    }
        ...
        public void tick() {
            ...
            if (this.target != null && !this.target.isDeadOrDying()){
                ...
                if (this.preacher.healTick == 10){
                    this.target.heal(AttributesConfig.get(AttributesConfig.PreacherHeal).floatValue());
