...
public class PoisonQuill extends Arrow implements ISpellEntity {
    ...
    public PoisonQuill(Level p_36861_, double p_36862_, double p_36863_, double p_36864_) {
        this(ModEntityType.POISON_QUILL.get(), p_36861_);
    ...
    public PoisonQuill(Level p_36866_, LivingEntity p_36867_) {
        this(ModEntityType.POISON_QUILL.get(), p_36866_);
    ...
    protected void onHitEntity(EntityHitResult pResult) {
        if (!this.level().isClientSide) {
            ...
            float damage = entity1 instanceof Mob mob ? (float) mob.getAttributeValue(Attributes.ATTACK_DAMAGE) : SpellConfig.get(SpellConfig.PoisonDartDamage).floatValue();
                ...
                if (flag) {
                    if (entity.isAlive()) {
                        if (this.level() instanceof net.minecraft.server.level.ServerLevel serverLevel) {
                            EnchantmentHelper.doPostAttackEffectsWithItemSource(serverLevel, entity, damageSource, this.getPickupItem());
                        }
                    }
                }
            } else {
            ...
            if (flag && entity.getType() != EntityType.ENDERMAN && entity instanceof LivingEntity livingEntity) {
                if (entity1 instanceof LivingEntity) {
                    MobUtil.doPostAttackEffects(this, livingEntity, damageSource, this.getPickupItem());
                }
