...
public class SignalerServant extends AbstractIllagerServant{
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Mob.createMobAttributes()
                ...
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.SignalerServantHealth))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.SignalerServantArmor))
                .add(Attributes.ATTACK_DAMAGE, 5.0F)
                .add(Attributes.FOLLOW_RANGE, AttributesConfig.get(AttributesConfig.SignalerServantFollowRange));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.SignalerServantHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.SignalerServantArmor));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.FOLLOW_RANGE), AttributesConfig.get(AttributesConfig.SignalerServantFollowRange));
    }
    ...
    public double getAttributeValue(Holder<Attribute> attribute) {
        ...
        if (attribute == Attributes.FOLLOW_RANGE) {
            if (this.getAttribute(Attributes.FOLLOW_RANGE) == null) {
                original = AttributesConfig.get(AttributesConfig.SignalerServantFollowRange);
            }
    ...
    protected ResourceKey<LootTable> getDefaultLootTable() {
        if (this.isNatural()){
            return ResourceKey.create(Registries.LOOT_TABLE, ModLootTables.NATURAL_SIGNALER);
        } else {
