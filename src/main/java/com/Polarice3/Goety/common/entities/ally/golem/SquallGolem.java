...
public class SquallGolem extends AbstractGolemServant implements IWindPowered {
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Monster.createMonsterAttributes()
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.SquallGolemHealth))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.SquallGolemArmor))
                .add(Attributes.MOVEMENT_SPEED, 0.3D)
                .add(Attributes.KNOCKBACK_RESISTANCE, 1.0D)
                .add(Attributes.ATTACK_KNOCKBACK, 1.25D)
                .add(Attributes.STEP_HEIGHT, 1.0D)
                .add(Attributes.ATTACK_DAMAGE, AttributesConfig.get(AttributesConfig.SquallGolemDamage))
                .add(Attributes.FOLLOW_RANGE, AttributesConfig.get(AttributesConfig.SquallGolemFollowRange));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.SquallGolemHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.SquallGolemArmor));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), AttributesConfig.get(AttributesConfig.SquallGolemDamage));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.FOLLOW_RANGE), AttributesConfig.get(AttributesConfig.SquallGolemFollowRange));
    }
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor pLevel, DifficultyInstance pDifficulty, MobSpawnType pReason, @Nullable SpawnGroupData pSpawnData) {
        if (pReason == MobSpawnType.STRUCTURE) {
            ...
            this.setBoundPos(this.blockPosition());
            this.setHealth(AttributesConfig.get(AttributesConfig.SquallGolemHealth).floatValue());
    ...
    class MeleeGoal extends Goal {
        ...
        public void hurtTarget(Entity target) {
            ...
            DamageSource damageSource = SquallGolem.this.getServantAttack();
