...
public class RedstoneGolem extends RaiderGolemServant {
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Monster.createMonsterAttributes()
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.RedstoneGolemHealth))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.RedstoneGolemArmor))
                .add(Attributes.MOVEMENT_SPEED, (double)0.3F)
                .add(Attributes.KNOCKBACK_RESISTANCE, 1.0D)
                .add(Attributes.ATTACK_KNOCKBACK, 3.0D)
                .add(Attributes.STEP_HEIGHT, 1.0D)
                .add(Attributes.ATTACK_DAMAGE, AttributesConfig.get(AttributesConfig.RedstoneGolemDamage))
                .add(Attributes.FOLLOW_RANGE, AttributesConfig.get(AttributesConfig.RedstoneGolemFollowRange));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.RedstoneGolemHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.RedstoneGolemArmor));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), AttributesConfig.get(AttributesConfig.RedstoneGolemDamage));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.FOLLOW_RANGE), AttributesConfig.get(AttributesConfig.RedstoneGolemFollowRange));
    }
    ...
    class AttackGoal extends MeleeAttackGoal {
        ...
        protected void checkAndPerformAttack(LivingEntity enemy) {
            double distToEnemySqr = RedstoneGolem.this.distanceToSqr(enemy.getX(), enemy.getY(), enemy.getZ());
    ...
    class MeleeGoal extends Goal {
        ...
        public void hurtTarget(Entity target) {
            ...
            if (flag) {
                ...
                if (RedstoneGolem.this.level() instanceof ServerLevel serverLevel) {
                    EnchantmentHelper.doPostAttackEffects(serverLevel, target, RedstoneGolem.this.getServantAttack());
                }
