...
public class QuickGrowingVine extends AbstractVine{
    ...
    public static AttributeSupplier.Builder setCustomAttributes(){
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.QuickGrowingVineHealth))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.QuickGrowingVineArmor))
    ...
    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.QuickGrowingVineHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.QuickGrowingVineArmor));
    }
