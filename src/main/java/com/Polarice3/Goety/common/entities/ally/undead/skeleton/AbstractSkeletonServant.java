...
public abstract class AbstractSkeletonServant extends Summoned implements RangedAttackMob, IMobTyped {
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.SkeletonServantHealth))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.SkeletonServantArmor))
                .add(Attributes.MOVEMENT_SPEED, 0.25F)
                .add(Attributes.ATTACK_DAMAGE, AttributesConfig.get(AttributesConfig.SkeletonServantDamage));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.SkeletonServantHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.SkeletonServantArmor));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), AttributesConfig.get(AttributesConfig.SkeletonServantDamage));
    }

    public double getBaseRangeDamage(){
        return AttributesConfig.get(AttributesConfig.SkeletonServantRangeDamage);
    }
    ...
    public int getSummonLimit(LivingEntity owner) {
        return SpellConfig.get(SpellConfig.SkeletonLimit);
    }
    ...
    public void performRangedAttack(LivingEntity target, float distanceFactor) {
        ...
        abstractarrowentity.setBaseDamage(abstractarrowentity.getBaseDamage() + MobUtil.getSpecialAttackDamage(this, (float)(this.getArrowPower() + this.getBaseRangeDamage())));
    ...
    protected AbstractArrow getMobArrow(ItemStack arrowStack, float distanceFactor) {
        ItemStack weapon = this.getItemInHand(ProjectileUtil.getWeaponHoldingHand(this, item -> item instanceof BowItem));
        AbstractArrow abstractarrowentity = ProjectileUtil.getMobArrow(this, arrowStack, distanceFactor, weapon);
        if (this.isUpgraded()) {
