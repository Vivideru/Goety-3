...
public class MagicBolt extends SpellHurtingProjectile {
    ...
    protected void onHitEntity(EntityHitResult pResult) {
        ...
        float damage = SpellConfig.get(SpellConfig.MagicBoltDamage).floatValue() * WandUtil.damageMultiply();
        boolean flag;
        if (livingentity != null) {
            ...
            DamageSource damageSource = ModDamageSource.magicBolt(this, livingentity);
