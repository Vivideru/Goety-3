...
public class BrewArrow extends Arrow {
    ...
    public BrewArrow(Level p_36861_, double p_36862_, double p_36863_, double p_36864_) {
        super(p_36861_, p_36862_, p_36863_, p_36864_, new ItemStack(Items.ARROW), null);
    }
    ...
    public void setEffectsFromItem(ItemStack p_36879_) {
        if (p_36879_.is(Items.TIPPED_ARROW)) {
            Collection<MobEffectInstance> collection0 = ModPotionUtil.getCustomEffects(p_36879_);
    ...
    public static int getCustomColor(ItemStack p_36885_) {
        CompoundTag compoundtag = p_36885_.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag();
