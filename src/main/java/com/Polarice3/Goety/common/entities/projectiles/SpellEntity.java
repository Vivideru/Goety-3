...
public abstract class SpellEntity extends Entity implements OwnableEntity, ISpellEntity {
    ...
    public void readAdditionalSaveData(CompoundTag compound) {
        ...
        if (compound.contains("CastingStaff")) {
            this.setCastingStaff(ItemStack.parse(this.registryAccess(), compound.getCompound("CastingStaff")).orElse(ItemStack.EMPTY));
        }
    }
    ...
    public void addAdditionalSaveData(CompoundTag compound) {
        ...
        if (!this.getCastingStaff().isEmpty()) {
            compound.put("CastingStaff", this.getCastingStaff().save(this.registryAccess()));
        }
    }
