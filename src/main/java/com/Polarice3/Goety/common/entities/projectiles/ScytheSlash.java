...
public class ScytheSlash extends AbstractHurtingProjectile {
    ...
    public ScytheSlash(ItemStack itemStack, Level world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
        super(ModEntityType.SCYTHE.get(), x, y, z, new Vec3(xSpeed, ySpeed, zSpeed), world);
                        ...
                        if (this.getOwner() != null) {
                            if (this.getOwner() instanceof Player player) {
                                ...
                                if (entity instanceof LivingEntity livingEntity) {
                                    f = MobUtil.getEnchantedDamage(this, this.weapon, livingEntity, damageSource, f);
                                }
                                boolean attack = entity.hurt(damageSource, f);
                                if (entity instanceof EnderDragon enderDragonEntity) {
                                    attack = enderDragonEntity.hurt(damageSource, f);
                                }
                                if (attack && entity instanceof LivingEntity) {
                                    int enchantment = MobUtil.getItemEnchantmentLevel(this, this.weapon, ModEnchantments.SOUL_EATER);
