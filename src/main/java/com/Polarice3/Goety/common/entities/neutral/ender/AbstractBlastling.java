...
public class AbstractBlastling extends AbstractEnderling implements RangedAttackMob {
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.BlastlingHealth))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.BlastlingArmor))
                .add(Attributes.FOLLOW_RANGE, 15.0D)
                .add(Attributes.MOVEMENT_SPEED, 0.25D)
                .add(Attributes.ATTACK_DAMAGE, AttributesConfig.get(AttributesConfig.BlastlingDamage));
    }

    public void setConfigurableAttributes() {
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.BlastlingHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.BlastlingArmor));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), AttributesConfig.get(AttributesConfig.BlastlingDamage));
    }
    ...
    public int getSummonLimit(LivingEntity owner) {
        return SpellConfig.get(SpellConfig.BlastlingLimit);
    }
    ...
    // Adapted from @Infamous-Misadventures: https://github.com/Infamous-Misadventures/Dungeons-Mobs/blob/1.19/src/main/java/com/infamous/dungeons_mobs/entities/ender/BlastlingEntity.java#L41
