...
public class CaveSpiderServant extends SpiderServant{
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return SpiderServant.setCustomAttributes()
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.CaveSpiderServantHealth))
                .add(Attributes.ATTACK_DAMAGE, AttributesConfig.get(AttributesConfig.CaveSpiderServantDamage));
    }

    public void setConfigurableAttributes() {
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.CaveSpiderServantHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), AttributesConfig.get(AttributesConfig.CaveSpiderServantDamage));
    }
