...
public class GeomancerServant extends SpellcasterIllagerServant{
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Monster.createMonsterAttributes()
                ...
                .add(Attributes.FOLLOW_RANGE, AttributesConfig.get(AttributesConfig.GeomancerServantFollowRange))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.GeomancerServantArmor))
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.GeomancerServantHealth));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.GeomancerServantHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.GeomancerServantArmor));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.FOLLOW_RANGE), AttributesConfig.get(AttributesConfig.GeomancerServantFollowRange));
    }
    ...
    protected ResourceKey<LootTable> getDefaultLootTable() {
        if (this.isNatural()){
            return ResourceKey.create(Registries.LOOT_TABLE, ModLootTables.NATURAL_GEOMANCER);
        } else {
