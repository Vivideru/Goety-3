...
public class GulfTentacle extends Owned {
    ...
    public static AttributeSupplier.Builder setCustomAttributes(){
        return Mob.createMobAttributes()
                .add(Attributes.ATTACK_DAMAGE, SpellConfig.get(SpellConfig.WaterWhipDamage) * WandUtil.damageMultiply());
    }

    @Override
    public void setConfigurableAttributes() {
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), SpellConfig.get(SpellConfig.WaterWhipDamage) * WandUtil.damageMultiply());
    }
            ...
            if (flag) {
                ...
                if (this.isStaff) {
                    ...
                    if (this.hasEffect(GoetyEffects.BUFF)) {
                        gulfTentacle.addEffect(new MobEffectInstance(GoetyEffects.BUFF, EffectsUtil.infiniteEffect(), EffectsUtil.getAmplifier(this, GoetyEffects.BUFF.get()), false, false));
                    }
