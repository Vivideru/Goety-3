...
public class Envioker extends HuntingIllagerEntity {
    ...
    public static AttributeSupplier.Builder setCustomAttributes(){
        return Mob.createMobAttributes()
                ...
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.EnviokerHealth))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.EnviokerArmor))
                .add(Attributes.MOVEMENT_SPEED, 0.35D)
                .add(Attributes.ATTACK_DAMAGE, AttributesConfig.get(AttributesConfig.EnviokerDamage));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.EnviokerHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.EnviokerArmor));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), AttributesConfig.get(AttributesConfig.EnviokerDamage));
    }
    ...
    class SummonSpellGoal extends SpellcasterUseSpellGoal {
        ...
        protected void performSpellCasting() {
            ...
            if (tormentorEntity != null) {
                ...
                tormentorEntity.finalizeSpawn(serverworld, Envioker.this.level().getCurrentDifficultyAt(blockpos), MobSpawnType.MOB_SUMMONED, null);
