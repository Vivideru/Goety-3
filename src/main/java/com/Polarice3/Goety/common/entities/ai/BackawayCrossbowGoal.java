...
public class BackawayCrossbowGoal<T extends PathfinderMob & RangedAttackMob & CrossbowAttackMob> extends Goal {
    ...
    public void stop() {
        ...
        if (this.mob.isUsingItem()) {
            ...
            this.clearCrossbowCharge(this.mob.getUseItem());
        }
    ...
    public void tick() {
        ...
        if (livingentity != null) {
            ...
            if (this.crossbowState == CrossbowState.UNCHARGED && !CrossbowItem.isCharged(activeStack)) {
                ...
                this.clearCrossbowCharge(this.mob.getItemInHand(ProjectileUtil.getWeaponHoldingHand(this.mob, item -> item instanceof CrossbowItem)));
                this.crossbowState = CrossbowState.UNCHARGED;
            }
        }
    }
