            ...
            if (!this.witch.level().isClientSide) {
                if (this.witch.level().getServer() != null) {
                    ...
                    if (this.witch instanceof Heretic){
                        loottable = this.getLootTable(ModLootTables.HERETIC_BARTER);
                    }
                    if (this.witch instanceof Reprobate){
                        loottable = this.getLootTable(ModLootTables.REPROBATE_BARTER);
                    }
                    if (this.witch instanceof Crone){
                        loottable = this.getLootTable(ModLootTables.CRONE_BARTER);
                    }
                    if (this.witch instanceof Heresiarch){
                        loottable = this.getLootTable(ModLootTables.HERESIARCH_BARTER);
                    }
