                ...
                if (!targets.isEmpty()){
                    for (Entity entity : targets) {
                        ...
                        if (hellfire) {
                            ...
                            entity.hurt(ModDamageSource.hellfire(this, this.owner), AttributesConfig.get(AttributesConfig.ApostleMagicDamage).floatValue() + this.getExtraDamage());
                        } else {
                            float damage = 5.0F;
                            if (this.owner != null){
                        ...
                        if (entity instanceof LivingEntity livingEntity) {
                            ...
                            if (this.burning > 0){
                                livingEntity.igniteForSeconds(this.burning * 4.0F);
                            }
                        }
                    }
                }
