...
public class HauntedSkull extends Minion implements IMobTyped {
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Mob.createMobAttributes()
                ...
                .add(Attributes.ATTACK_DAMAGE, SpellConfig.get(SpellConfig.HauntedSkullDamage));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), SpellConfig.get(SpellConfig.HauntedSkullDamage));
    }
