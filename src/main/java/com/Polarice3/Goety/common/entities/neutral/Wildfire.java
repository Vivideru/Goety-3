...
public class Wildfire extends Summoned implements IMobTyped {
    ...
    public static AttributeSupplier.Builder setCustomAttributes(){
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.WildfireHealth))
                .add(Attributes.ATTACK_DAMAGE, AttributesConfig.get(AttributesConfig.WildfireMeleeDamage))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.WildfireArmor))
    ...
    public void setConfigurableAttributes() {
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.WildfireHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), AttributesConfig.get(AttributesConfig.WildfireMeleeDamage));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.WildfireArmor));
    }
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(SHIELD_HEALTH, AttributesConfig.get(AttributesConfig.WildfireShieldHealth).floatValue());
    }
    ...
    public int getSummonLimit(LivingEntity owner) {
        return SpellConfig.get(SpellConfig.WildfireLimit);
    }
    ...
    public void setShieldHealth(float shieldHealth) {
        this.entityData.set(SHIELD_HEALTH, Mth.clamp(shieldHealth, 0.0F, AttributesConfig.get(AttributesConfig.WildfireShieldHealth).floatValue()));
    }
    ...
    public void breakShield(){
        if (this.getShields() > 0){
            ...
            this.setShieldHealth(AttributesConfig.get(AttributesConfig.WildfireShieldHealth).floatValue());
    ...
    public class SummonBlazes extends Goal implements IMobTyped {

        @Override
        public ModMobType getGoetyMobType() {
            return Wildfire.this.getGoetyMobType();
        }
        ...
        public void start() {
            ...
            if (Wildfire.this.level() instanceof ServerLevel serverLevel) {
                for (int i1 = 0; i1 < 1 + serverLevel.random.nextInt(1); ++i1) {
                    ...
                    blazeServant.setTrueOwner(MobUtil.getSummonOwner(Wildfire.this));
    ...
    public class ShockwaveAttackGoal extends Goal implements IMobTyped{
    ...
    public class IdleGoal extends Goal implements IMobTyped {
        ...
        public void tick() {
            if (this.attackTime <= 0 && this.target != null && this.target.distanceTo(this.mob) > 10.0F){
                ...
                if (this.attackTime == 5) {
                    float damage = AttributesConfig.get(AttributesConfig.WildfireRangeDamage).floatValue() + this.mob.getFireBallDamage();
    ...
    public class SeekFireGoal extends MoveToBlockGoal implements IMobTyped {
