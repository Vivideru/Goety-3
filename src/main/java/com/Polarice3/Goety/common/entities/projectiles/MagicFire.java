...
public class MagicFire extends GroundProjectile {
    ...
    public void tick() {
        ...
        if (this.level().isClientSide) {
            ...
            this.level().addParticle(new MagicSmokeParticleOption(0xffffff, 0x7f00b3, 10 + this.level().getRandom().nextInt(10), 0.2F), this.getRandomX(0.5D), this.getRandomY(), this.getRandomZ(0.5D), 0.0D, 0.0D, 0.0D);
