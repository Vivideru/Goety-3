...
public class CryologerServant extends SpellcasterIllagerServant implements IBreathing {
    ...
    public static AttributeSupplier.Builder setCustomAttributes(){
        return Mob.createMobAttributes()
                ...
                .add(Attributes.MAX_HEALTH, AttributesConfig.get(AttributesConfig.CryologerHealth))
                .add(Attributes.ARMOR, AttributesConfig.get(AttributesConfig.CryologerArmor))
                .add(Attributes.MOVEMENT_SPEED, 0.5D)
                .add(Attributes.ATTACK_DAMAGE, AttributesConfig.get(AttributesConfig.CryologerDamage));
    }

    public void setConfigurableAttributes(){
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH), AttributesConfig.get(AttributesConfig.CryologerHealth));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR), AttributesConfig.get(AttributesConfig.CryologerArmor));
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE), AttributesConfig.get(AttributesConfig.CryologerDamage));
    }
    ...
    protected ResourceKey<LootTable> getDefaultLootTable() {
        if (this.isNatural()){
            return ModEntityType.CRYOLOGER.get().getDefaultLootTable();
        } else {
    ...
    public void doBreathing(Entity target) {
        ...
        float damage = MobUtil.getSpecialAttackDamage(this, 1.0F);
