...
public class BlinkSpell extends Spell {
    ...
    public static void enderTeleportEvent(LivingEntity player, BlockPos target) {
        ...
        net.neoforged.neoforge.event.entity.EntityTeleportEvent.EnderEntity event = net.neoforged.neoforge.event.EventHooks.onEnderTeleport(player, blockPos.getX(), blockPos.getY(), blockPos.getZ());
        if (!event.isCanceled()) {
