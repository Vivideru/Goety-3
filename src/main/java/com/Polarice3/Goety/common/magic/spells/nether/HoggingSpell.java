...
public class HoggingSpell extends SummonSpell {
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        if (WandUtil.enchantedFocus(caster)){
            ...
            radius += WandUtil.getLevels(ModEnchantments.RADIUS, caster) / 2.0F;
        }
        ...
        hoglin.setTrueOwner(MobUtil.getSummonOwner(caster));
        ...
        hoglin.finalizeSpawn(worldIn, worldIn.getCurrentDifficultyAt(caster.blockPosition()), MobSpawnType.MOB_SUMMONED, null);
        ...
        if (this.rightStaff(staff)) {
            ...
            hoglin2.setTrueOwner(MobUtil.getSummonOwner(caster));
            ...
            hoglin2.finalizeSpawn(worldIn, worldIn.getCurrentDifficultyAt(caster.blockPosition()), MobSpawnType.MOB_SUMMONED, null);
