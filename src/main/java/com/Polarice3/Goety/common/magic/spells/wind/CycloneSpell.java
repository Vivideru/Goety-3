...
public class CycloneSpell extends Spell {
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        if (WandUtil.enchantedFocus(caster)){
            ...
            duration *= (WandUtil.getLevels(ModEnchantments.DURATION, caster) + 1);
            velocity += WandUtil.getLevels(ModEnchantments.VELOCITY, caster);
            radius += (WandUtil.getLevels(ModEnchantments.RADIUS, caster) / 10.0F);
        }
