...
public class MagmaSpell extends Spell {
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat){
        ...
        float velocity = spellStat.getVelocity() + WandUtil.getLevels(ModEnchantments.VELOCITY, caster) / 3.0F;
        float extraBlast = WandUtil.getLevels(ModEnchantments.RADIUS, caster) / 2.0F;
        ...
        blast.setDuration(spellStat.getDuration() + WandUtil.getLevels(ModEnchantments.DURATION, caster));
