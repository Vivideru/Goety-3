...
public class EvilEyeEffect extends BrewMobEffect {
    ...
    public EvilEyeEffect(MobEffectCategory p_19451_, int p_19452_, BooleanSupplier curable) {
        super(p_19451_, p_19452_, curable);
    }
                        ...
                        if (spawner != null) {
                            if (SpawnPlacements.checkSpawnRules(spawner.type, serverLevel, MobSpawnType.SPAWNER, living.blockPosition(), serverLevel.random)) {
                                ...
                                if (entity instanceof Mob mob) {
                                    ...
                                    EventHooks.finalizeMobSpawn(mob, serverLevel, serverLevel.getCurrentDifficultyAt(blockPos), MobSpawnType.SPAWNER, (SpawnGroupData) null);
