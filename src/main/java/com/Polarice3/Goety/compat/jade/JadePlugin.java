...
public class JadePlugin implements IWailaPlugin {
    ...
    public void registerClient(IWailaClientRegistration registration) {
        ...
        registration.registerEntityComponent(SummonOwnerProvider.INSTANCE, Owned.class);
        registration.registerEntityComponent(SummonOwnerProvider.INSTANCE, AbstractSpiderServant.class);
        registration.registerEntityComponent(SummonOwnerProvider.INSTANCE, SpellEntity.class);
