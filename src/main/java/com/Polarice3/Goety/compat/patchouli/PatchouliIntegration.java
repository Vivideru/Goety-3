...
public class PatchouliIntegration implements ICompatable {
    public void setup(FMLCommonSetupEvent event) {
        registerMultiblock(Goety.location("whisperer"), WHISPERER);
        registerMultiblock(Goety.location("leapleaf"), LEAPLEAF);
        registerMultiblock(Goety.location("ice_golem"), ICE_GOLEM);
        registerMultiblock(Goety.location("squall_golem"), SQUALL_GOLEM);
        registerMultiblock(Goety.location("redstone_golem"), REDSTONE_GOLEM);
        registerMultiblock(Goety.location("redstone_golem_revive"), REDSTONE_GOLEM_REVIVE);
        registerMultiblock(Goety.location("grave_golem"), GRAVE_GOLEM);
        registerMultiblock(Goety.location("grave_golem_revive"), GRAVE_GOLEM_REVIVE);
        registerMultiblock(Goety.location("redstone_monstrosity"), REDSTONE_MONSTROSITY);
        registerMultiblock(Goety.location("redstone_monstrosity_revive"), REDSTONE_MONSTROSITY_REVIVE);
        registerMultiblock(Goety.location("so_example"), SO_EXAMPLE);
    }

    private static void registerMultiblock(ResourceLocation id, Supplier<IMultiblock> multiblock) {
        try {
            PatchouliAPI.get().registerMultiblock(id, multiblock.get());
    ...
    public static final Supplier<IMultiblock> REDSTONE_MONSTROSITY_REVIVE = Suppliers.memoize(() -> {
        ...
        return PatchouliAPI.get().makeMultiblock(
                ...
                'H', ModBlocks.REDSTONE_MONSTROSITY_HEAD_BLOCK.get(),
                '#', redstoneBlocks,
                'R', reinforced,
                'D', diamondMold,
                '0', diamondMold
