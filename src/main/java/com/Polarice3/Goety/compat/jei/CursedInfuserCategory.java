...
public class CursedInfuserCategory implements IRecipeCategory<CursedInfuserRecipes> {
    ...
    public CursedInfuserCategory(IGuiHelper guiHelper) {
        ...
        this.background = guiHelper.drawableBuilder(ResourceLocation.fromNamespaceAndPath(Goety.MOD_ID, "textures/gui/jei/jei_gui.png"), 0, 220, 82, 36)
                .addPadding(0, 0, 0, 0)
                .build();
        ...
        this.cachedArrows = CacheBuilder.newBuilder()
                ...
                .build(new CacheLoader<Integer, IDrawableAnimated>() {
                    ...
                    public IDrawableAnimated load(Integer cookTime) {
                        return guiHelper.drawableBuilder(ResourceLocation.fromNamespaceAndPath(Goety.MOD_ID, "textures/gui/jei/jei_gui.png"), 82, 128, 24, 17)
