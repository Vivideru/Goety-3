...
public interface ITrainable {
    ...
    default void completeTraining(EntityType<? extends Mob> entityType){
        if (this instanceof Mob mob){
            if (EventHooks.canLivingConvert(mob, entityType, (timer) -> {})) {
                ...
                if (converted != null){
                    ...
                    if (mob.level() instanceof ServerLevel serverLevel) {
                        EventHooks.finalizeMobSpawn(converted, serverLevel, serverLevel.getCurrentDifficultyAt(converted.blockPosition()), MobSpawnType.CONVERSION, null);
                    }
