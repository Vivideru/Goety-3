...
public interface ISpell {
    ...
    List<ResourceKey<Enchantment>> acceptedEnchantments();
    ...
    default ParticleOptions getParticle(LivingEntity caster){
        return net.minecraft.core.particles.ColorParticleOption.create(ParticleTypes.ENTITY_EFFECT, this.particleColors(caster).red(), this.particleColors(caster).green(), this.particleColors(caster).blue());
    }
