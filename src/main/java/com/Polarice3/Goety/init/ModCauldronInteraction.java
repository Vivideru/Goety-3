...
public interface ModCauldronInteraction {
    CauldronInteraction.InteractionMap VOID = newInteractionMap("goety_void");
    ...
    static CauldronInteraction.InteractionMap newInteractionMap(String name) {
        ...
        CauldronInteraction.INTERACTIONS.put(name, interactionMap);
        return interactionMap;
    }

    static void init() {
        VOID.map().put(Items.BUCKET, (p_175725_, p_175726_, p_175727_, p_175728_, p_175729_, p_175730_) -> {
        ...
        VOID.map().put(Items.GLASS_BOTTLE, (p_175718_, p_175719_, p_175720_, p_175721_, p_175722_, p_175723_) -> {
        ...
        VOID.map().put(ModItems.VOID_BOTTLE.get(), (p_175704_, p_175705_, p_175706_, p_175707_, p_175708_, p_175709_) -> {
        ...
        CauldronInteraction.EMPTY.map().put(ModItems.VOID_BOTTLE.get(), (p_175732_, p_175733_, p_175734_, p_175735_, p_175736_, p_175737_) -> {
        ...
        CauldronInteraction.EMPTY.map().put(ModItems.VOID_BUCKET.get(), (blockState, level, blockPos, player, hand, itemStack) -> CauldronInteraction.emptyBucket(level, blockPos, player, hand, itemStack, ModBlocks.VOID_CAULDRON.get().defaultBlockState().setValue(LayeredCauldronBlock.LEVEL, 3), SoundEvents.BUCKET_EMPTY_LAVA));

        MUD.map().put(Items.BUCKET, (p_175725_, p_175726_, p_175727_, p_175728_, p_175729_, p_175730_) -> {
        ...
        MUD.map().put(Items.GLASS_BOTTLE, (p_175718_, p_175719_, p_175720_, p_175721_, p_175722_, p_175723_) -> {
            if (!p_175719_.isClientSide) {
                Item item = p_175723_.getItem();
        ...
        MUD.map().put(ModItems.END_MUD_BOTTLE.get(), (p_175704_, p_175705_, p_175706_, p_175707_, p_175708_, p_175709_) -> {
            if (p_175704_.getValue(LayeredCauldronBlock.LEVEL) != 3) {
                if (!p_175705_.isClientSide) {
                    p_175707_.setItemInHand(p_175708_, ItemUtils.createFilledResult(p_175709_, p_175707_, new ItemStack(Items.GLASS_BOTTLE)));
                    p_175707_.awardStat(Stats.USE_CAULDRON);
        ...
        CauldronInteraction.EMPTY.map().put(ModItems.END_MUD_BOTTLE.get(), (p_175732_, p_175733_, p_175734_, p_175735_, p_175736_, p_175737_) -> {
            if (!p_175733_.isClientSide) {
                Item item = p_175737_.getItem();
                p_175735_.setItemInHand(p_175736_, ItemUtils.createFilledResult(p_175737_, p_175735_, new ItemStack(Items.GLASS_BOTTLE)));
                p_175735_.awardStat(Stats.USE_CAULDRON);
        ...
        CauldronInteraction.EMPTY.map().put(ModItems.END_MUD_BUCKET.get(), (blockState, level, blockPos, player, hand, itemStack) -> CauldronInteraction.emptyBucket(level, blockPos, player, hand, itemStack, ModBlocks.END_MUD_CAULDRON.get().defaultBlockState().setValue(LayeredCauldronBlock.LEVEL, 3), SoundEvents.BUCKET_EMPTY));
    }
}
