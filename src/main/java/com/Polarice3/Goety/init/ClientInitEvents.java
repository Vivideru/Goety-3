...
public class ClientInitEvents {
    ...
    public static void clientInit(FMLClientSetupEvent event){
        ...
        event.enqueueWork(() -> {
            ...
            ItemProperties.register(ModItems.TOTEM_OF_SOULS.get(), ResourceLocation.parse("souls"),
                    (stack, world, living, seed) -> ((float) ITotem.currentSouls(stack)) / ITotem.maximumSouls(stack));
            ItemProperties.register(ModItems.TOTEM_OF_SOULS.get(), ResourceLocation.parse("activated"),
                    (stack, world, living, seed) -> TotemOfSouls.isActivated(stack) ? 1.0F : 0.0F);
            ItemProperties.register(ModItems.FLAME_CAPTURE.get(), ResourceLocation.parse("capture"),
                    (stack, world, living, seed) -> FlameCaptureItem.hasEntity(stack) ? 1.0F : 0.0F);
            ItemProperties.register(ModItems.SOUL_JAR.get(), ResourceLocation.parse("type"),
            ...
            ItemProperties.register(ModItems.TAGLOCK_KIT.get(), ResourceLocation.parse("tagged"),
                    (stack, world, living, seed) -> TaglockKit.hasEntity(stack) ? 1.0F : 0.0F);
            ItemProperties.register(ModItems.WAYSTONE.get(), ResourceLocation.parse("store"),
                    (stack, world, living, seed) -> WaystoneItem.hasBlock(stack) ? 1.0F : 0.0F);
            ItemProperties.register(ModItems.ETERNAL_CAULDRON.get(), ResourceLocation.parse("filled"),
                    (stack, world, living, seed) -> !EternalCauldronItem.getBottle(stack).isEmpty() ? 1.0F : 0.0F);
            ItemProperties.register(ModItems.TRANSFER_SCROLL.get(), ResourceLocation.parse("signed"),
                    (stack, world, living, seed) -> TransferScroll.hasSummon(stack) ? 1.0F : 0.0F);
            ItemProperties.register(ModItems.ARCA_COMPASS.get(), ResourceLocation.parse("angle")
                    , new CompassItemPropertyFunction((p_234992_, p_234993_, p_234994_) -> {
                        return ArcaCompassItem.getArcaPosition(ArcaCompassItem.tag(p_234993_));
                    }));
            ItemProperties.register(ModItems.HUNTERS_BOW.get(), ResourceLocation.parse("pull"),
                    (stack, world, living, seed) -> {
                        if (living == null) {
                            return 0.0F;
                        } else {
                            return living.getUseItem() != stack ? 0.0F : (float)(stack.getUseDuration(living) - living.getUseItemRemainingTicks()) / 20;
                        }
                    });
            ItemProperties.register(ModItems.HUNTERS_BOW.get(), ResourceLocation.parse("pulling")
                    , (stack, world, living, seed) -> living != null && living.isUsingItem() && living.getUseItem() == stack ? 1.0F : 0.0F);
            /*ItemProperties.register(ModItems.REVOLVER_CROSSBOW.get(), ResourceLocation.parse("pull")
                    , (stack, world, living, seed) -> {
                if (living == null) {
                    return 0.0F;
                } else {
            ...
            ItemProperties.register(ModItems.REVOLVER_CROSSBOW.get(), ResourceLocation.parse("pulling")
            ...
            ItemProperties.register(ModItems.REVOLVER_CROSSBOW.get(), ResourceLocation.parse("charged")
                    , (stack, world, living, seed) -> RevolverCrossbowItem.isCharged(stack) ? 1.0F : 0.0F);
            ItemProperties.register(ModItems.REVOLVER_CROSSBOW.get(), ResourceLocation.parse("firework")
            ...
            ItemProperties.register(ModItems.CALL_FOCUS.get(), ResourceLocation.parse("active")
                    , (stack, world, living, seed) -> CallFocus.hasSummon(stack) ? 1.0F : 0.0F);
            ItemProperties.register(ModItems.TROOP_FOCUS.get(), ResourceLocation.parse("active")
                    , (stack, world, living, seed) -> TroopFocus.hasSummonType(stack) ? 1.0F : 0.0F);
            ItemProperties.register(ModItems.RECALL_FOCUS.get(), ResourceLocation.parse("active")
                    , (stack, world, living, seed) -> RecallFocus.hasRecall(stack) ? 1.0F : 0.0F);
            ItemProperties.register(ModItems.INFERNAL_TOME.get(), ResourceLocation.parse("active")
                    , (stack, world, living, seed) -> living != null && living.isUsingItem() && (living.getUseItem() == stack || InfernalTome.isChanting(stack)) ? 1.0F : 0.0F);
            ItemProperties.register(ModItems.OMINOUS_CHARM.get(), ResourceLocation.parse("active")
                    , (stack, world, living, seed) -> OminousCharmItem.hasOmen(stack) ? 1.0F : 0.0F);
            ItemProperties.register(ModItems.COMMAND_HORN.get(), ResourceLocation.parse("mode")
                    , (stack, world, living, seed) -> {
            ...
            ItemProperties.register(ModItems.ESOTERIC_TESSERACT.get(), ResourceLocation.parse("active")
    ...
    public static void registerScreens(RegisterMenuScreensEvent event) {
        ...
        event.register(ModContainerType.ETERNAL_CAULDRON.get(), EternalCauldronScreen::new);
        event.register(ModContainerType.DARK_ANVIL.get(), DarkAnvilScreen::new);
        event.register(ModContainerType.CRAFTING_FOCUS.get(), CraftingScreen::new);
    }
    ...
    /**
     * Adapted from @TeamTwilight's AddLayer code: <a href="https://github.com/TeamTwilight/twilightforest/blob/1.20.x/src/main/java/twilightforest/client/TFClientSetup.java">...</a>
     */
    @Nullable
    ...
    public static void addLayers(EntityRenderersEvent.AddLayers event){
        if (fieldEntityRenderer == null) {
            try {
                ...
                Goety.LOGGER.error("Unable to access entity renderer map for client layers", e);
            }
        }
        if (fieldEntityRenderer != null) {
            ...
            try {
                ...
                Goety.LOGGER.error("Unable to attach client entity render layers", e);
            }
        }
    }
    ...
    public static void registerGUI(final RegisterGuiLayersEvent event){
        ...
        event.registerAbove(VanillaGuiLayers.EXPERIENCE_BAR, Goety.location("current_focus_hud"), CurrentFocusGui.OVERLAY);
    }
    ...
    public static void onRegisterRenders(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerBlockEntityRenderer(ModBlockEntities.THRONE.get(), ModBlockEntityRenderer::new);
    ...
    public static void colorItem(RegisterColorHandlersEvent.Item event){
        event.register((itemStack, i) -> i > 0 ? -1 : ModPotionUtil.getColor(itemStack),
    ...
    public static void modelBake(ModelEvent.ModifyBakingResult event) {
        List<Map.Entry<ModelResourceLocation, BakedModel>> models =  event.getModels().entrySet().stream()
                .filter(entry -> entry.getKey().id().getNamespace().equals(Goety.MOD_ID)
                        && entry.getKey().id().getPath().contains("leaves")
                        && !entry.getKey().id().getPath().contains("mcd")
                        && !entry.getKey().id().getPath().contains("chorus")).toList();

        models.forEach(entry -> event.getModels().put(entry.getKey(), new BakedLeavesModel(entry.getValue())));

        List<Map.Entry<ModelResourceLocation, BakedModel>> models2 =  event.getModels().entrySet().stream()
                .filter(entry -> entry.getKey().id().getNamespace().equals(Goety.MOD_ID)
                        && entry.getKey().id().getPath().contains("leaves")
                        && (entry.getKey().id().getPath().contains("mcd") || entry.getKey().id().getPath().contains("chorus"))).toList();
