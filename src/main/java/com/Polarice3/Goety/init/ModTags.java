...
public class ModTags {
    ...
    public static class EntityTypes {
        ...
        public static final TagKey<EntityType<?>> NECROMANCERS = tag("necromancers");
        public static final TagKey<EntityType<?>> REAPERS = tag("reapers");
        public static final TagKey<EntityType<?>> WRAITHS = tag("wraiths");
        public static final TagKey<EntityType<?>> BOUND_ILLAGERS = tag("bound_illagers");
