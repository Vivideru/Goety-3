...
public class ClientSideInit extends SidedInit {
    ...
    public void init() {
        com.Polarice3.Goety.Goety.getModEventBus().addListener(this::setupParticles);
    }
    ...
    public void setupParticles(RegisterParticleProvidersEvent event) {
        ...
        event.registerSpriteSet(ModParticleTypes.CULT_SPELL.get(), AdditiveSpellParticle.MobProvider::new);
